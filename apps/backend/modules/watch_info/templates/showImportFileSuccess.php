        ...
        <tr class="sf_admin_row odd">
            ...
            <td>
              <ul class="sf_admin_td_actions">
                <?php if($valido): ?>
                  <li class="sf_admin_action_import"><?php echo link_to('Importar conteúdo do ficheiro', 'watch_info_load_import_file', array(), array('method' => 'post', 'confirm' => 'Tem a certeza que pretende carregar o conteúdo do ficheiro para a base de dados?')) ?></li>
                <?php else: ?>
                  <li class="sf_admin_action_reload"><?php echo link_to('Recarregar ficheiro', 'watch_info_collection', array('action' => 'upload')) ?></li>
                <?php endif; ?>
              </ul>
            </td>
          </tr>
