...
<script type="text/javascript">
   ...
   */
  $(function(){
    initialize('ginfo', 'frontend', null, null, <?php echo $general_info->getId() ?>);
  });
</script>
...
<div id="sf_admin_container" class="map-container">
  <h1 style="text-align: left;">Mapa de Avistamentos da Saída de <?php echo $general_info->getDate('Y-m-d') ?></h1>
