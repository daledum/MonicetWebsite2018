...
<?php if($element->getLogotype()): ?>
    <?php echo link_to_if($element->getLink(), image_tag('/uploads/consorcium/tn_'.$element->getLogotype(), 'align=left vspace=10 hspace=10 width=140px alt_title='.$element->getName()), $element->getLink(), 'target=_blank') ?>
<?php endif ?>
