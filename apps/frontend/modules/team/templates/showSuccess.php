...
<br />
<?php if($element->getPhoto()) echo link_to_if($element->getLink(), image_tag('/uploads/team/tn_' . $element->getPhoto(), 'align=left vspace=10 hspace=10 width="140px" alt_title=' . $element->getName()), $element->getLink()) ?>
<!--
