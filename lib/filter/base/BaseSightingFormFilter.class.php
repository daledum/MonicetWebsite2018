...
abstract class BaseSightingFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'number_vessels' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'cubs'           => new sfValidatorPass(array('required' => false)),
      'total'          => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'number_vessels' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
