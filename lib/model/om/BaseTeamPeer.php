...
abstract class BaseTeamPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Slug', 'Type', 'Name', 'Link', 'Photo', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'slug', 'type', 'name', 'link', 'photo', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::SLUG, self::TYPE, self::NAME, self::LINK, self::PHOTO, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'SLUG', 'TYPE', 'NAME', 'LINK', 'PHOTO', 'CREATED_AT', 'UPDATED_AT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'slug', 'type', 'name', 'link', 'photo', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Slug' => 1, 'Type' => 2, 'Name' => 3, 'Link' => 4, 'Photo' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'slug' => 1, 'type' => 2, 'name' => 3, 'link' => 4, 'photo' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::SLUG => 1, self::TYPE => 2, self::NAME => 3, self::LINK => 4, self::PHOTO => 5, self::CREATED_AT => 6, self::UPDATED_AT => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'SLUG' => 1, 'TYPE' => 2, 'NAME' => 3, 'LINK' => 4, 'PHOTO' => 5, 'CREATED_AT' => 6, 'UPDATED_AT' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'slug' => 1, 'type' => 2, 'name' => 3, 'link' => 4, 'photo' => 5, 'created_at' => 6, 'updated_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(TeamPeer::SLUG);
			$criteria->addSelectColumn(TeamPeer::TYPE);
			$criteria->addSelectColumn(TeamPeer::NAME);
			$criteria->addSelectColumn(TeamPeer::LINK);
			$criteria->addSelectColumn(TeamPeer::PHOTO);
	...
	{
		// Invalidate objects in TeamI18nPeer instance pool, 
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = TeamPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + TeamPeer::NUM_COLUMNS;
		} else {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			$c = clone $criteria;
			$affectedRows += TeamPeer::doOnDeleteCascade($c, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related TeamI18n objects
			$criteria = new Criteria(TeamI18nPeer::DATABASE_NAME);
			
			$criteria->add(TeamI18nPeer::ID, $obj->getId());
			$affectedRows += TeamI18nPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
	...
	/**
	 * Selects a collection of {@link Team} objects with a {@link TeamI18n} translation populated.
	 *
	 * @param Criteria  $criteria
	...
	static public function doSelectWithI18n(Criteria $criteria, $culture = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
	  ...
	  TeamPeer::addSelectColumns($criteria);
	  $startcol = (TeamPeer::NUM_COLUMNS - TeamPeer::NUM_LAZY_LOAD_COLUMNS);
	  TeamI18nPeer::addSelectColumns($criteria);
	  $criteria->addJoin(TeamPeer::ID, TeamI18nPeer::ID, $join_behavior);
	  $criteria->add(TeamI18nPeer::CULTURE, $culture);
	
	  foreach (sfMixer::getCallables('BaseTeam:doSelectJoin:doSelectJoin') as $sf_hook)
	  {
	    call_user_func($sf_hook, 'Team', $criteria, $con);
	  }
	  ...
	  $stmt = BasePeer::doSelect($criteria, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = TeamPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = TeamPeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
	  		...
	  		// $obj1->hydrate($row, 0, true); // rehydrate
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
	      TeamPeer::addInstanceToPool($obj1, $key1);
			} // if $obj1 already loaded
	
			$key2 = TeamI18nPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = TeamI18nPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					$cls = TeamI18nPeer::getOMClass(false);
					$obj2 = new $cls();
					$obj2->hydrate($row, $startcol);
					TeamI18nPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded
	
	      $obj1->setTeamI18nForCulture($obj2, $culture);
