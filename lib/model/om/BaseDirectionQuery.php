...
abstract class BaseDirectionQuery extends ModelCriteria
{
	...
	{
		if ($this->getFormatter()->isObjectFormatter() && (null !== ($obj = DirectionPeer::getInstanceFromPool((string) $key)))) {
	...
	{
		if (is_array($id)) {
			return $this->addUsingAlias(DirectionPeer::ID, $id, Criteria::IN);
		} else {
			return $this->addUsingAlias(DirectionPeer::ID, $id, Criteria::EQUAL);
		}
	}
	...
	public function filterByAcronym($acronym = null)
	{
		if(preg_match('/[\%\*]/', $acronym)) {
			return $this->addUsingAlias(DirectionPeer::ACRONYM, str_replace('*', '%', $acronym), Criteria::LIKE);
		} else {
			return $this->addUsingAlias(DirectionPeer::ACRONYM, $acronym, Criteria::EQUAL);
		}
	}
	...
	public function filterByCreatedAt($createdAt = null)
	{
		if (is_array($createdAt)) {
			if (array_values($createdAt) === $createdAt) {
				return $this->addUsingAlias(DirectionPeer::CREATED_AT, $createdAt, Criteria::IN);
			} else {
			...
			return $this->addUsingAlias(DirectionPeer::CREATED_AT, $createdAt, Criteria::EQUAL);
		}
	}
	...
	public function filterByUpdatedAt($updatedAt = null)
	{
		if (is_array($updatedAt)) {
			if (array_values($updatedAt) === $updatedAt) {
				return $this->addUsingAlias(DirectionPeer::UPDATED_AT, $updatedAt, Criteria::IN);
			} else {
			...
			return $this->addUsingAlias(DirectionPeer::UPDATED_AT, $updatedAt, Criteria::EQUAL);
		}
	}
	...
	{
		return $this
			->addUsingAlias(DirectionPeer::ID, $watchSighting->getDirectionId(), Criteria::EQUAL);
	}
