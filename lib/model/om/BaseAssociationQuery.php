 ...
 *
 * @method     AssociationQuery leftJoin($relation) Adds a LEFT JOIN clause to the query
 * @method     AssociationQuery rightJoin($relation) Adds a RIGHT JOIN clause to the query
 * @method     AssociationQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     AssociationQuery leftJoinAssociationI18n($relationAlias = null) Adds a LEFT JOIN clause to the query using the AssociationI18n relation
 * @method     AssociationQuery rightJoinAssociationI18n($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AssociationI18n relation
 * @method     AssociationQuery innerJoinAssociationI18n($relationAlias = null) Adds a INNER JOIN clause to the query using the AssociationI18n relation
 *
 * @method     AssociationQuery leftJoinSighting($relationAlias = null) Adds a LEFT JOIN clause to the query using the Sighting relation
 * @method     AssociationQuery rightJoinSighting($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Sighting relation
 * @method     AssociationQuery innerJoinSighting($relationAlias = null) Adds a INNER JOIN clause to the query using the Sighting relation
 *
 * @method     Association findOne(PropelPDO $con = null) Return the first Association matching the query
 * @method     Association findOneOrCreate(PropelPDO $con = null) Return the first Association matching the query, or a new Association object populated from the query conditions when no match is found
 *
...
abstract class BaseAssociationQuery extends ModelCriteria
{
	...
	/**
	 * Returns a new AssociationQuery object.
	 *
	...
	{
		if ($criteria instanceof AssociationQuery) {
			return $criteria;
		}
	 ...
	 *
	 * @return    Association|array|mixed the result, formatted by the current formatter
	 */
	public function findPk($key, $con = null)
	{
		if ((null !== ($obj = AssociationPeer::getInstanceFromPool((string) $key))) && $this->getFormatter()->isObjectFormatter()) {
	...
	public function filterById($id = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(AssociationPeer::ID, $id, $comparison);
	}
	...
	public function filterByCode($code = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(AssociationPeer::CODE, $code, $comparison);
	}
	...
	public function filterByCreatedAt($createdAt = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(AssociationPeer::CREATED_AT, $createdAt, $comparison);
	}
	...
	public function filterByUpdatedAt($updatedAt = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(AssociationPeer::UPDATED_AT, $updatedAt, $comparison);
	}
	 ...
	 * @return    AssociationQuery The current query, for fluid interface
	 */
	public function filterByAssociationI18n($associationI18n, $comparison = null)
	{
		return $this
			->addUsingAlias(AssociationPeer::ID, $associationI18n->getId(), $comparison);
	}

	/**
	 * Adds a JOIN clause to the query using the AssociationI18n relation
	 * 
	 ...
	 * @return    AssociationQuery The current query, for fluid interface
	 */
	public function joinAssociationI18n($relationAlias = null, $joinType = Criteria::INNER_JOIN)
	{
		$tableMap = $this->getTableMap();
		$relationMap = $tableMap->getRelation('AssociationI18n');
		...
		if($relationAlias) {
			...
			$this->addJoinObject($join, 'AssociationI18n');
		}
	 ...
	 */
	public function useAssociationI18nQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
	{
		return $this
			->joinAssociationI18n($relationAlias, $joinType)
	...
	{
		return $this
			->addUsingAlias(AssociationPeer::ID, $sighting->getAssociationId(), $comparison);
	}
