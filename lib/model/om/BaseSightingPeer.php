...
abstract class BaseSightingPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'RecordId', 'SpecieId', 'BehaviourId', 'AssociationId', 'Adults', 'Juveniles', 'Cubs', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'recordId', 'specieId', 'behaviourId', 'associationId', 'adults', 'juveniles', 'cubs', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::RECORD_ID, self::SPECIE_ID, self::BEHAVIOUR_ID, self::ASSOCIATION_ID, self::ADULTS, self::JUVENILES, self::CUBS, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'record_id', 'specie_id', 'behaviour_id', 'association_id', 'adults', 'juveniles', 'cubs', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'RecordId' => 1, 'SpecieId' => 2, 'BehaviourId' => 3, 'AssociationId' => 4, 'Adults' => 5, 'Juveniles' => 6, 'Cubs' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'recordId' => 1, 'specieId' => 2, 'behaviourId' => 3, 'associationId' => 4, 'adults' => 5, 'juveniles' => 6, 'cubs' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::RECORD_ID => 1, self::SPECIE_ID => 2, self::BEHAVIOUR_ID => 3, self::ASSOCIATION_ID => 4, self::ADULTS => 5, self::JUVENILES => 6, self::CUBS => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'record_id' => 1, 'specie_id' => 2, 'behaviour_id' => 3, 'association_id' => 4, 'adults' => 5, 'juveniles' => 6, 'cubs' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
