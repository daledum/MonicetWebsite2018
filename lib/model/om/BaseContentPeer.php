...
abstract class BaseContentPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Section', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'section', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::SECTION, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'SECTION', 'CREATED_AT', 'UPDATED_AT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'section', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Section' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'section' => 1, 'createdAt' => 2, 'updatedAt' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::SECTION => 1, self::CREATED_AT => 2, self::UPDATED_AT => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'SECTION' => 1, 'CREATED_AT' => 2, 'UPDATED_AT' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'section' => 1, 'created_at' => 2, 'updated_at' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(ContentPeer::SECTION);
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = ContentPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + ContentPeer::NUM_COLUMNS;
		} else {
