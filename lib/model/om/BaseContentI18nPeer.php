...
abstract class BaseContentI18nPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'description', 'culture', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::DESCRIPTION, self::CULTURE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DESCRIPTION', 'CULTURE', ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'description' => 1, 'culture' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DESCRIPTION => 1, self::CULTURE => 2, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DESCRIPTION' => 1, 'CULTURE' => 2, ),
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = ContentI18nPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + ContentI18nPeer::NUM_COLUMNS;
		} else {
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(ContentI18nPeer::CULTURE);
			if ($value) {
				$selectCriteria->add(ContentI18nPeer::CULTURE, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(ContentI18nPeer::TABLE_NAME);
			}
