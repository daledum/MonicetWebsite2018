  ...
  const PEER = 'GeneralInfoPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->base_latitude = ($row[$startcol + 6] !== null) ? (double) $row[$startcol + 6] : null;
			$this->base_longitude = ($row[$startcol + 7] !== null) ? (double) $row[$startcol + 7] : null;
			...
			return $startcol + 14; // 14 = GeneralInfoPeer::NUM_COLUMNS - GeneralInfoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->asfGuardUser !== null && $this->created_by !== $this->asfGuardUser->getId()) {
			$this->asfGuardUser = null;
		}
	} // ensureConsistency
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(GeneralInfoPeer::CREATED_BY, $this->created_by);
	...
	{
		return (null === $this->getId()) && (null === $this->getCreatedBy());
	}
	...
	public function getSkipper(PropelPDO $con = null)
	{
		if ($this->aSkipper === null && ($this->skipper_id !== null)) {
			$this->aSkipper = SkipperQuery::create()->findPk($this->skipper_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
	...
	public function getGuide(PropelPDO $con = null)
	{
		if ($this->aGuide === null && ($this->guide_id !== null)) {
			$this->aGuide = GuideQuery::create()->findPk($this->guide_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->created_by !== null)) {
			$this->asfGuardUser = sfGuardUserQuery::create()->findPk($this->created_by);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUser->addGeneralInfos($this);
			 */
		}
