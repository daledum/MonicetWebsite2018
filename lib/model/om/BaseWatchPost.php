...
/**
 * Base class that represents a row from the 'watch_post' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseWatchPost extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'WatchPostPeer';
	 ...
	 * @return     WatchPost The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = WatchPostPeer::ID;
		}
	...
	public function setCompanyId($v)
	{
		...
		if ($this->company_id !== $v) {
			$this->company_id = $v;
			$this->modifiedColumns[] = WatchPostPeer::COMPANY_ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = WatchPostPeer::NAME;
		}
	...
	public function setLatitude($v)
	{
		...
		if ($this->latitude !== $v) {
			$this->latitude = $v;
			$this->modifiedColumns[] = WatchPostPeer::LATITUDE;
		}
	...
	public function setLongitude($v)
	{
		...
		if ($this->longitude !== $v) {
			$this->longitude = $v;
			$this->modifiedColumns[] = WatchPostPeer::LONGITUDE;
		}
	...
	public function setHeight($v)
	{
		...
		if ($this->height !== $v) {
			$this->height = $v;
			$this->modifiedColumns[] = WatchPostPeer::HEIGHT;
		}
	...
	public function setObservations($v)
	{
		...
		if ($this->observations !== $v) {
			$this->observations = $v;
			$this->modifiedColumns[] = WatchPostPeer::OBSERVATIONS;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = WatchPostPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = WatchPostPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->height = ($row[$startcol + 5] !== null) ? (double) $row[$startcol + 5] : null;
			...
			return $startcol + 9; // 9 = WatchPostPeer::NUM_COLUMNS - WatchPostPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating WatchPost object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = WatchPostPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseWatchPost:delete:pre') as $callable)
			{
			...
			if ($ret) {
				WatchPostQuery::create()
					->filterByPrimaryKey($this->getPrimaryKey())
					->delete($con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseWatchPost:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseWatchPost:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(WatchPostPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(WatchPostPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseWatchPost:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				WatchPostPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(WatchPostPeer::ID) ) {
					...
					$affectedRows += WatchPostPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = WatchPostPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = WatchPostPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = WatchPostPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(WatchPostPeer::ID)) $criteria->add(WatchPostPeer::ID, $this->id);
		if ($this->isColumnModified(WatchPostPeer::COMPANY_ID)) $criteria->add(WatchPostPeer::COMPANY_ID, $this->company_id);
		if ($this->isColumnModified(WatchPostPeer::NAME)) $criteria->add(WatchPostPeer::NAME, $this->name);
		if ($this->isColumnModified(WatchPostPeer::LATITUDE)) $criteria->add(WatchPostPeer::LATITUDE, $this->latitude);
		if ($this->isColumnModified(WatchPostPeer::LONGITUDE)) $criteria->add(WatchPostPeer::LONGITUDE, $this->longitude);
		if ($this->isColumnModified(WatchPostPeer::HEIGHT)) $criteria->add(WatchPostPeer::HEIGHT, $this->height);
		if ($this->isColumnModified(WatchPostPeer::OBSERVATIONS)) $criteria->add(WatchPostPeer::OBSERVATIONS, $this->observations);
		if ($this->isColumnModified(WatchPostPeer::CREATED_AT)) $criteria->add(WatchPostPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(WatchPostPeer::UPDATED_AT)) $criteria->add(WatchPostPeer::UPDATED_AT, $this->updated_at);
	...
	{
		$criteria = new Criteria(WatchPostPeer::DATABASE_NAME);
		$criteria->add(WatchPostPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of WatchPost (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     WatchPost Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     WatchPostPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new WatchPostPeer();
		}
		return self::$peer;
	}
	...
	public function getCompany(PropelPDO $con = null)
	{
		if ($this->aCompany === null && ($this->company_id !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 $this->aCompany->addWatchPosts($this);
			 */
		}
	 ...
	 * If this WatchPost is new, it will return
	 ...
	 * Otherwise if this WatchPost is new, it will return
	 * an empty collection; or if this WatchPost has previously
	 * been saved, it will retrieve related WatchInfos from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in WatchPost.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 ...
	 * @return     PropelCollection|array WatchInfo[] List of WatchInfo objects
	 */
	public function getWatchInfosJoinCompany($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = WatchInfoQuery::create(null, $criteria);
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseWatchPost:' . $name))
		{
