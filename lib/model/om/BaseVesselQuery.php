...
abstract class BaseVesselQuery extends ModelCriteria
{
	...
	{
		if ($this->getFormatter()->isObjectFormatter() && (null !== ($obj = VesselPeer::getInstanceFromPool((string) $key)))) {
	...
	{
		if (is_array($id)) {
			return $this->addUsingAlias(VesselPeer::ID, $id, Criteria::IN);
		} else {
			return $this->addUsingAlias(VesselPeer::ID, $id, Criteria::EQUAL);
		}
	}
	...
	public function filterByCompanyId($companyId = null)
	{
		if (is_array($companyId)) {
			if (array_values($companyId) === $companyId) {
				return $this->addUsingAlias(VesselPeer::COMPANY_ID, $companyId, Criteria::IN);
			} else {
			...
			return $this->addUsingAlias(VesselPeer::COMPANY_ID, $companyId, Criteria::EQUAL);
		}
	}
	...
	{
		if(preg_match('/[\%\*]/', $name)) {
			return $this->addUsingAlias(VesselPeer::NAME, str_replace('*', '%', $name), Criteria::LIKE);
		} else {
			return $this->addUsingAlias(VesselPeer::NAME, $name, Criteria::EQUAL);
		}
	}
	 ...
	 * @return    VesselQuery The current query, for fluid interface
	 */
	public function filterByLength($length = null)
	{
		if (is_array($length)) {
			if (array_values($length) === $length) {
				return $this->addUsingAlias(VesselPeer::LENGTH, $length, Criteria::IN);
			} else {
				if (isset($length['min'])) {
			...
			return $this->addUsingAlias(VesselPeer::LENGTH, $length, Criteria::EQUAL);
		}
	}
	 ...
	 * @return    VesselQuery The current query, for fluid interface
	 */
	public function filterByPower($power = null)
	{
		if (is_array($power)) {
			if (array_values($power) === $power) {
				return $this->addUsingAlias(VesselPeer::POWER, $power, Criteria::IN);
			} else {
				if (isset($power['min'])) {
			...
			return $this->addUsingAlias(VesselPeer::POWER, $power, Criteria::EQUAL);
		}
	}
	...
	public function filterByHeight($height = null)
	{
		if (is_array($height)) {
			if (array_values($height) === $height) {
				return $this->addUsingAlias(VesselPeer::HEIGHT, $height, Criteria::IN);
			} else {
				if (isset($height['min'])) {
			...
			return $this->addUsingAlias(VesselPeer::HEIGHT, $height, Criteria::EQUAL);
		}
	}
	...
	public function filterByObservations($observations = null)
	{
		if(preg_match('/[\%\*]/', $observations)) {
			return $this->addUsingAlias(VesselPeer::OBSERVATIONS, str_replace('*', '%', $observations), Criteria::LIKE);
		} else {
			return $this->addUsingAlias(VesselPeer::OBSERVATIONS, $observations, Criteria::EQUAL);
		}
	}
	...
	public function filterByCreatedAt($createdAt = null)
	{
		if (is_array($createdAt)) {
			if (array_values($createdAt) === $createdAt) {
				return $this->addUsingAlias(VesselPeer::CREATED_AT, $createdAt, Criteria::IN);
			} else {
			...
			return $this->addUsingAlias(VesselPeer::CREATED_AT, $createdAt, Criteria::EQUAL);
		}
	}
	...
	public function filterByUpdatedAt($updatedAt = null)
	{
		if (is_array($updatedAt)) {
			if (array_values($updatedAt) === $updatedAt) {
				return $this->addUsingAlias(VesselPeer::UPDATED_AT, $updatedAt, Criteria::IN);
			} else {
			...
			return $this->addUsingAlias(VesselPeer::UPDATED_AT, $updatedAt, Criteria::EQUAL);
		}
	}
	...
	{
		return $this
			->addUsingAlias(VesselPeer::COMPANY_ID, $company->getId(), Criteria::EQUAL);
	}
	...
	{
		return $this
			->addUsingAlias(VesselPeer::ID, $generalInfo->getVesselId(), Criteria::EQUAL);
	}
	...
	{
		return $this
			->addUsingAlias(VesselPeer::ID, $watchSighting->getVesselId(), Criteria::EQUAL);
	}
