...
abstract class BaseSpecieGroupPeer {
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(SpecieGroupPeer::NAME);
	...
	{
		// invalidate objects in SpeciePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSpecieGroupPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseSpecieGroupPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSpecieGroupPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseSpecieGroupPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSpecieGroupPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseSpecieGroupPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSpecieGroupPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseSpecieGroupPeer', $values, $con, $ret);
    }
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$affectedRows += BasePeer::doDeleteAll(SpecieGroupPeer::TABLE_NAME, $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += SpecieGroupPeer::doOnDeleteCascade($criteria, $con);
