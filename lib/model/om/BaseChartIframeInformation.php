...
abstract class BaseChartIframeInformation extends BaseObject  implements Persistent
{
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->chart_item = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->chart_type = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->selected = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->resetModified();
			...
			return $startcol + 8; // 8 = ChartIframeInformationPeer::NUM_COLUMNS - ChartIframeInformationPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		$result = array(
			...
			$keys[4] => $this->getYear(),
			$keys[5] => $this->getChartItem(),
			$keys[6] => $this->getChartType(),
			$keys[7] => $this->getSelected(),
		);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setChartItem($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setChartType($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setSelected($arr[$keys[7]]);
	}
