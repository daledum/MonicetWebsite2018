...
abstract class BaseGeneralInfoPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'VesselId', 'SkipperId', 'GuideId', 'BaseLatitude', 'BaseLongitude', 'Date', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'vesselId', 'skipperId', 'guideId', 'baseLatitude', 'baseLongitude', 'date', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::VESSEL_ID, self::SKIPPER_ID, self::GUIDE_ID, self::BASE_LATITUDE, self::BASE_LONGITUDE, self::DATE, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'VESSEL_ID', 'SKIPPER_ID', 'GUIDE_ID', 'BASE_LATITUDE', 'BASE_LONGITUDE', 'DATE', 'CREATED_AT', 'UPDATED_AT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'vessel_id', 'skipper_id', 'guide_id', 'base_latitude', 'base_longitude', 'date', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'VesselId' => 1, 'SkipperId' => 2, 'GuideId' => 3, 'BaseLatitude' => 4, 'BaseLongitude' => 5, 'Date' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'vesselId' => 1, 'skipperId' => 2, 'guideId' => 3, 'baseLatitude' => 4, 'baseLongitude' => 5, 'date' => 6, 'createdAt' => 7, 'updatedAt' => 8, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::VESSEL_ID => 1, self::SKIPPER_ID => 2, self::GUIDE_ID => 3, self::BASE_LATITUDE => 4, self::BASE_LONGITUDE => 5, self::DATE => 6, self::CREATED_AT => 7, self::UPDATED_AT => 8, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'VESSEL_ID' => 1, 'SKIPPER_ID' => 2, 'GUIDE_ID' => 3, 'BASE_LATITUDE' => 4, 'BASE_LONGITUDE' => 5, 'DATE' => 6, 'CREATED_AT' => 7, 'UPDATED_AT' => 8, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'vessel_id' => 1, 'skipper_id' => 2, 'guide_id' => 3, 'base_latitude' => 4, 'base_longitude' => 5, 'date' => 6, 'created_at' => 7, 'updated_at' => 8, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, 8, )
	);
