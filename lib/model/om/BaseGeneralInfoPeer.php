...
abstract class BaseGeneralInfoPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'VesselId', 'SkipperId', 'GuideId', 'BaseLatitude', 'BaseLongitude', 'Date', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'vesselId', 'skipperId', 'guideId', 'baseLatitude', 'baseLongitude', 'date', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::VESSEL_ID, self::SKIPPER_ID, self::GUIDE_ID, self::BASE_LATITUDE, self::BASE_LONGITUDE, self::DATE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'vessel_id', 'skipper_id', 'guide_id', 'base_latitude', 'base_longitude', 'date', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'VesselId' => 1, 'SkipperId' => 2, 'GuideId' => 3, 'BaseLatitude' => 4, 'BaseLongitude' => 5, 'Date' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'vesselId' => 1, 'skipperId' => 2, 'guideId' => 3, 'baseLatitude' => 4, 'baseLongitude' => 5, 'date' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::VESSEL_ID => 1, self::SKIPPER_ID => 2, self::GUIDE_ID => 3, self::BASE_LATITUDE => 4, self::BASE_LONGITUDE => 5, self::DATE => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'vessel_id' => 1, 'skipper_id' => 2, 'guide_id' => 3, 'base_latitude' => 4, 'base_longitude' => 5, 'date' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
