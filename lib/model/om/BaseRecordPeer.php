...
abstract class BaseRecordPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'CodeId', 'VisibilityId', 'SeaStateId', 'GeneralInfoId', 'Time', 'Latitude', 'Longitude', 'Comments', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'codeId', 'visibilityId', 'seaStateId', 'generalInfoId', 'time', 'latitude', 'longitude', 'comments', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CODE_ID, self::VISIBILITY_ID, self::SEA_STATE_ID, self::GENERAL_INFO_ID, self::TIME, self::LATITUDE, self::LONGITUDE, self::COMMENTS, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'code_id', 'visibility_id', 'sea_state_id', 'general_info_id', 'time', 'latitude', 'longitude', 'comments', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'CodeId' => 1, 'VisibilityId' => 2, 'SeaStateId' => 3, 'GeneralInfoId' => 4, 'Time' => 5, 'Latitude' => 6, 'Longitude' => 7, 'Comments' => 8, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'codeId' => 1, 'visibilityId' => 2, 'seaStateId' => 3, 'generalInfoId' => 4, 'time' => 5, 'latitude' => 6, 'longitude' => 7, 'comments' => 8, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CODE_ID => 1, self::VISIBILITY_ID => 2, self::SEA_STATE_ID => 3, self::GENERAL_INFO_ID => 4, self::TIME => 5, self::LATITUDE => 6, self::LONGITUDE => 7, self::COMMENTS => 8, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'code_id' => 1, 'visibility_id' => 2, 'sea_state_id' => 3, 'general_info_id' => 4, 'time' => 5, 'latitude' => 6, 'longitude' => 7, 'comments' => 8, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, 8, )
	);
