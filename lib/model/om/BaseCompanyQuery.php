...
abstract class BaseCompanyQuery extends ModelCriteria
{
	...
	public function filterByCountry($country = null)
	{
		if(preg_match('/[\%\*]/', $country)) {
			return $this->addUsingAlias(CompanyPeer::COUNTRY, str_replace('*', '%', $country), Criteria::LIKE);
		} else {
			return $this->addUsingAlias(CompanyPeer::COUNTRY, $country, Criteria::EQUAL);
		}
	}
	...
	{
		return $this
			->addUsingAlias(CompanyPeer::ID, $watchInfo->getCompanyId(), Criteria::EQUAL);
	}
	...
	{
		return $this
			->addUsingAlias(CompanyPeer::ID, $watchman->getCompanyId(), Criteria::EQUAL);
	}
	...
	{
		return $this
			->addUsingAlias(CompanyPeer::ID, $watchPost->getCompanyId(), Criteria::EQUAL);
	}
