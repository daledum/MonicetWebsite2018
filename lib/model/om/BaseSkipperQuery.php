...
abstract class BaseSkipperQuery extends ModelCriteria
{
	...
	{
		if ($this->getFormatter()->isObjectFormatter() && (null !== ($obj = SkipperPeer::getInstanceFromPool((string) $key)))) {
	...
	{
		if (is_array($id)) {
			return $this->addUsingAlias(SkipperPeer::ID, $id, Criteria::IN);
		} else {
			return $this->addUsingAlias(SkipperPeer::ID, $id, Criteria::EQUAL);
		}
	}
	...
	public function filterByCompanyId($companyId = null)
	{
		if (is_array($companyId)) {
			if (array_values($companyId) === $companyId) {
				return $this->addUsingAlias(SkipperPeer::COMPANY_ID, $companyId, Criteria::IN);
			} else {
			...
			return $this->addUsingAlias(SkipperPeer::COMPANY_ID, $companyId, Criteria::EQUAL);
		}
	}
	...
	{
		if(preg_match('/[\%\*]/', $name)) {
			return $this->addUsingAlias(SkipperPeer::NAME, str_replace('*', '%', $name), Criteria::LIKE);
		} else {
			return $this->addUsingAlias(SkipperPeer::NAME, $name, Criteria::EQUAL);
		}
	}
	...
	public function filterByObservations($observations = null)
	{
		if(preg_match('/[\%\*]/', $observations)) {
			return $this->addUsingAlias(SkipperPeer::OBSERVATIONS, str_replace('*', '%', $observations), Criteria::LIKE);
		} else {
			return $this->addUsingAlias(SkipperPeer::OBSERVATIONS, $observations, Criteria::EQUAL);
		}
	}
	...
	public function filterByCreatedAt($createdAt = null)
	{
		if (is_array($createdAt)) {
			if (array_values($createdAt) === $createdAt) {
				return $this->addUsingAlias(SkipperPeer::CREATED_AT, $createdAt, Criteria::IN);
			} else {
			...
			return $this->addUsingAlias(SkipperPeer::CREATED_AT, $createdAt, Criteria::EQUAL);
		}
	}
	...
	public function filterByUpdatedAt($updatedAt = null)
	{
		if (is_array($updatedAt)) {
			if (array_values($updatedAt) === $updatedAt) {
				return $this->addUsingAlias(SkipperPeer::UPDATED_AT, $updatedAt, Criteria::IN);
			} else {
			...
			return $this->addUsingAlias(SkipperPeer::UPDATED_AT, $updatedAt, Criteria::EQUAL);
		}
	}
	...
	{
		return $this
			->addUsingAlias(SkipperPeer::COMPANY_ID, $company->getId(), Criteria::EQUAL);
	}
	...
	{
		return $this
			->addUsingAlias(SkipperPeer::ID, $generalInfo->getSkipperId(), Criteria::EQUAL);
	}
