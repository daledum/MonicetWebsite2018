...
abstract class BaseLogPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Type', 'Message', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'type', 'message', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TYPE, self::MESSAGE, self::CREATED_AT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TYPE', 'MESSAGE', 'CREATED_AT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'type', 'message', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Type' => 1, 'Message' => 2, 'CreatedAt' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'type' => 1, 'message' => 2, 'createdAt' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TYPE => 1, self::MESSAGE => 2, self::CREATED_AT => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TYPE' => 1, 'MESSAGE' => 2, 'CREATED_AT' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'type' => 1, 'message' => 2, 'created_at' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
