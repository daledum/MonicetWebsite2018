...
abstract class BaseContent extends BaseObject  implements Persistent
{
	...
	public function setSection($v)
	{
		...
		if ($this->section !== $v) {
			$this->section = $v;
			$this->modifiedColumns[] = ContentPeer::SECTION;
		}
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(ContentPeer::ID) ) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ContentPeer::SECTION)) $criteria->add(ContentPeer::SECTION, $this->section);
	 ...
	 * @return     PropelCollection|array ContentI18n[] List of ContentI18n objects
	 * @throws     PropelException
	 */
	public function getContentI18ns($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collContentI18ns || null !== $criteria) {
	...
	/**
	 * Returns the "description" value from the current {@link ContentI18n}.
	 */
	public function getDescription($culture = null)
	{
	  return $this->getCurrentContentI18n($culture)->getDescription();
	}
	
	/**
	 * Sets the "description" value of the current {@link ContentI18n}.
	 *
	 * @return Content
	 */
	public function setDescription($value, $culture = null)
	{
	  $this->getCurrentContentI18n($culture)->setDescription($value);
	  return $this;
	}
