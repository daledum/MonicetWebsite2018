...
abstract class BaseUserQuery extends ModelCriteria
{
	...
	public function filterByDistrict($district = null)
	{
		if(preg_match('/[\%\*]/', $district)) {
			return $this->addUsingAlias(UserPeer::DISTRICT, str_replace('*', '%', $district), Criteria::LIKE);
		} else {
			return $this->addUsingAlias(UserPeer::DISTRICT, $district, Criteria::EQUAL);
		}
	}
	...
	public function filterByMunicipality($municipality = null)
	{
		if(preg_match('/[\%\*]/', $municipality)) {
			return $this->addUsingAlias(UserPeer::MUNICIPALITY, str_replace('*', '%', $municipality), Criteria::LIKE);
		} else {
			return $this->addUsingAlias(UserPeer::MUNICIPALITY, $municipality, Criteria::EQUAL);
		}
	}
