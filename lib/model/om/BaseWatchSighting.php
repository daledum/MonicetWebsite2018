  ...
  const PEER = 'WatchSightingPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->watch_behaviour_id = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		$result = array(
			...
			$keys[8] => $this->getWatchBehaviourId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[8], $arr)) $this->setWatchBehaviourId($arr[$keys[8]]);
	...
	public function getWatchInfo(PropelPDO $con = null)
	{
		if ($this->aWatchInfo === null && ($this->watch_info_id !== null)) {
			$this->aWatchInfo = WatchInfoQuery::create()->findPk($this->watch_info_id);
