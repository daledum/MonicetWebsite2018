...
abstract class BaseContentI18n extends BaseObject  implements Persistent
{
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = ContentI18nPeer::NUM_COLUMNS - ContentI18nPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		if ($includeForeignObjects) {
			if (null !== $this->aContent) {
				$result['Content'] = $this->aContent->toArray($keyType, $includeLazyLoadColumns, true);
			}
		}
		return $result;
	}
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseContentI18n:' . $name))
		{
