...
abstract class BaseBehaviour extends BaseObject  implements Persistent {
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = BehaviourPeer::DESCRIPTION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = BehaviourPeer::NUM_COLUMNS - BehaviourPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				BehaviourPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = BehaviourPeer::doInsert($this, $con);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BehaviourPeer::DESCRIPTION)) $criteria->add(BehaviourPeer::DESCRIPTION, $this->description);
	 ...
	 * Otherwise if this Behaviour has previously been saved, it will retrieve
	 * related Sightings from storage. If this Behaviour is new, it will return
		...
		if ($this->collSightings === null) {
			if ($this->isNew()) {
			   $this->collSightings = array();
				...
				$criteria->add(SightingPeer::BEHAVIOUR_ID, $this->id);
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseBehaviour:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseBehaviour::%s', $method));
	  }
