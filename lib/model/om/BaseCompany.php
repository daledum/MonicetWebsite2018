  ...
  const PEER = 'CompanyPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->base_latitude = ($row[$startcol + 3] !== null) ? (double) $row[$startcol + 3] : null;
			$this->base_longitude = ($row[$startcol + 4] !== null) ? (double) $row[$startcol + 4] : null;
			...
			$this->island = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->council = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[11] => $this->getIsland(),
			$keys[12] => $this->getCouncil(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[11], $arr)) $this->setIsland($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setCouncil($arr[$keys[12]]);
