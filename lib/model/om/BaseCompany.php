...
abstract class BaseCompany extends BaseObject  implements Persistent
{
  ...
  const PEER = 'CompanyPeer';
	...
	/**
	 * The value for the council field.
	 * @var        string
	 */
	protected $council;
	...
	public function setIsland($v)
	{
		...
		if ($this->island !== $v) {
			$this->island = $v;
			$this->modifiedColumns[] = CompanyPeer::ISLAND;
		}
	...
	/**
	 * Set the value of [council] column.
	 * 
	 * @param      string $v new value
	 * @return     Company The current object (for fluent API support)
	 */
	public function setCouncil($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->council !== $v) {
			$this->council = $v;
			$this->modifiedColumns[] = CompanyPeer::COUNCIL;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->island = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->council = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->locality = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[10] => $this->getIsland(),
			$keys[11] => $this->getCouncil(),
			$keys[12] => $this->getLocality(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[10], $arr)) $this->setIsland($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setCouncil($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setLocality($arr[$keys[12]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CompanyPeer::ISLAND)) $criteria->add(CompanyPeer::ISLAND, $this->island);
		if ($this->isColumnModified(CompanyPeer::COUNCIL)) $criteria->add(CompanyPeer::COUNCIL, $this->council);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCouncil($this->council);
	 ...
	 * actually need in Company.
	 */
	public function getGeneralInfosJoinsfGuardUserRelatedBySkipperId($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('GeneralInfo.sfGuardUserRelatedBySkipperId', $join_behavior);
	 ...
	 * actually need in Company.
	 */
	public function getGeneralInfosJoinsfGuardUserRelatedByGuideId($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('GeneralInfo.sfGuardUserRelatedByGuideId', $join_behavior);
