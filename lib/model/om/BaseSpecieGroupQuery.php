...
abstract class BaseSpecieGroupQuery extends ModelCriteria
{
	...
	public function filterByScientificName($scientificName = null)
	{
		if(preg_match('/[\%\*]/', $scientificName)) {
			return $this->addUsingAlias(SpecieGroupPeer::SCIENTIFIC_NAME, str_replace('*', '%', $scientificName), Criteria::LIKE);
		} else {
			return $this->addUsingAlias(SpecieGroupPeer::SCIENTIFIC_NAME, $scientificName, Criteria::EQUAL);
		}
	}
	 ...
	 * @return    SpecieGroupQuery The current query, for fluid interface
	 */
	public function filterBySpecieGroupI18n($specieGroupI18n)
	{
		return $this
			->addUsingAlias(SpecieGroupPeer::ID, $specieGroupI18n->getId(), Criteria::EQUAL);
	}
	 ...
	 */
	public function useSpecieGroupI18nQuery($relationAlias = '', $joinType = Criteria::INNER_JOIN)
	{
		return $this
			->join('SpecieGroupI18n' . ($relationAlias ? ' ' . $relationAlias : ''), $joinType)
