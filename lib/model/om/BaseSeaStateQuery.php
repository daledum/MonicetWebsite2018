 ...
 * @method     SeaStateQuery orderByDescription($order = Criteria::ASC) Order by the description column
 ...
 * @method     SeaStateQuery groupByDescription() Group by the description column
 ...
 * @method     SeaState findOneByCode(string $code) Return the first SeaState filtered by the code column
 * @method     SeaState findOneByDescription(string $description) Return the first SeaState filtered by the description column
 ...
 * @method     array findByCode(string $code) Return SeaState objects filtered by the code column
 * @method     array findByDescription(string $description) Return SeaState objects filtered by the description column
...
abstract class BaseSeaStateQuery extends ModelCriteria
{
	...
	{
		if ($this->getFormatter()->isObjectFormatter() && (null !== ($obj = SeaStatePeer::getInstanceFromPool((string) $key)))) {
	...
	{
		if (is_array($id)) {
			return $this->addUsingAlias(SeaStatePeer::ID, $id, Criteria::IN);
		} else {
			return $this->addUsingAlias(SeaStatePeer::ID, $id, Criteria::EQUAL);
		}
	}
	...
	{
		if(preg_match('/[\%\*]/', $code)) {
			return $this->addUsingAlias(SeaStatePeer::CODE, str_replace('*', '%', $code), Criteria::LIKE);
		} else {
			return $this->addUsingAlias(SeaStatePeer::CODE, $code, Criteria::EQUAL);
		}
	}
	...
	public function filterByDescription($description = null)
	{
		if(preg_match('/[\%\*]/', $description)) {
			return $this->addUsingAlias(SeaStatePeer::DESCRIPTION, str_replace('*', '%', $description), Criteria::LIKE);
		} else {
			return $this->addUsingAlias(SeaStatePeer::DESCRIPTION, $description, Criteria::EQUAL);
		}
	}
	...
	public function filterByCreatedAt($createdAt = null)
	{
		if (is_array($createdAt)) {
			if (array_values($createdAt) === $createdAt) {
				return $this->addUsingAlias(SeaStatePeer::CREATED_AT, $createdAt, Criteria::IN);
			} else {
			...
			return $this->addUsingAlias(SeaStatePeer::CREATED_AT, $createdAt, Criteria::EQUAL);
		}
	}
	...
	public function filterByUpdatedAt($updatedAt = null)
	{
		if (is_array($updatedAt)) {
			if (array_values($updatedAt) === $updatedAt) {
				return $this->addUsingAlias(SeaStatePeer::UPDATED_AT, $updatedAt, Criteria::IN);
			} else {
			...
			return $this->addUsingAlias(SeaStatePeer::UPDATED_AT, $updatedAt, Criteria::EQUAL);
		}
	}
	...
	{
		return $this
			->addUsingAlias(SeaStatePeer::ID, $record->getSeaStateId(), Criteria::EQUAL);
	}
