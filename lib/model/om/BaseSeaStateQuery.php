...
abstract class BaseSeaStateQuery extends ModelCriteria
{
	 ...
	 * @return    SeaStateQuery The current query, for fluid interface
	 */
	public function filterBySeaStateI18n($seaStateI18n)
	{
		return $this
			->addUsingAlias(SeaStatePeer::ID, $seaStateI18n->getId(), Criteria::EQUAL);
	}
	 ...
	 */
	public function useSeaStateI18nQuery($relationAlias = '', $joinType = Criteria::INNER_JOIN)
	{
		return $this
			->join('SeaStateI18n' . ($relationAlias ? ' ' . $relationAlias : ''), $joinType)
