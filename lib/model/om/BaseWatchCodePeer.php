...
abstract class BaseWatchCodePeer {
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseWatchCodePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseWatchCodePeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseWatchCodePeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseWatchCodePeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseWatchCodePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseWatchCodePeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseWatchCodePeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseWatchCodePeer', $values, $con, $ret);
    }
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$affectedRows += BasePeer::doDeleteAll(WatchCodePeer::TABLE_NAME, $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += WatchCodePeer::doOnDeleteCascade($criteria, $con);
	...
	/**
	 * Selects a collection of {@link WatchCode} objects with a {@link CodeI18n} translation populated.
	 *
	 * @param Criteria  $criteria
	...
	static public function doSelectWithI18n(Criteria $criteria, $culture = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
	  ...
	  $criteria->addJoin(WatchCodePeer::ID, CodeI18nPeer::ID, $join_behavior);
