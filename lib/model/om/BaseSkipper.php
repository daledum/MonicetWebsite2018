...
/**
 * Base class that represents a row from the 'skipper' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseSkipper extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'SkipperPeer';
	 ...
	 * @return     Skipper The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = SkipperPeer::ID;
		}
	...
	public function setCompanyId($v)
	{
		...
		if ($this->company_id !== $v) {
			$this->company_id = $v;
			$this->modifiedColumns[] = SkipperPeer::COMPANY_ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = SkipperPeer::NAME;
		}
	...
	public function setObservations($v)
	{
		...
		if ($this->observations !== $v) {
			$this->observations = $v;
			$this->modifiedColumns[] = SkipperPeer::OBSERVATIONS;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = SkipperPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = SkipperPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = SkipperPeer::NUM_COLUMNS - SkipperPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Skipper object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = SkipperPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseSkipper:delete:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseSkipper:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseSkipper:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(SkipperPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(SkipperPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseSkipper:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				SkipperPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(SkipperPeer::ID) ) {
					...
					$affectedRows += SkipperPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = SkipperPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = SkipperPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = SkipperPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SkipperPeer::ID)) $criteria->add(SkipperPeer::ID, $this->id);
		if ($this->isColumnModified(SkipperPeer::COMPANY_ID)) $criteria->add(SkipperPeer::COMPANY_ID, $this->company_id);
		if ($this->isColumnModified(SkipperPeer::NAME)) $criteria->add(SkipperPeer::NAME, $this->name);
		if ($this->isColumnModified(SkipperPeer::OBSERVATIONS)) $criteria->add(SkipperPeer::OBSERVATIONS, $this->observations);
		if ($this->isColumnModified(SkipperPeer::CREATED_AT)) $criteria->add(SkipperPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(SkipperPeer::UPDATED_AT)) $criteria->add(SkipperPeer::UPDATED_AT, $this->updated_at);
	...
	{
		$criteria = new Criteria(SkipperPeer::DATABASE_NAME);
		$criteria->add(SkipperPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Skipper (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Skipper Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getCompany(PropelPDO $con = null)
	{
		if ($this->aCompany === null && ($this->company_id !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 $this->aCompany->addSkippers($this);
			 */
		}
	 ...
	 * If this Skipper is new, it will return
	 ...
	 * Otherwise if this Skipper is new, it will return
	 * an empty collection; or if this Skipper has previously
	 * been saved, it will retrieve related GeneralInfos from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Skipper.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseSkipper:' . $name))
		{
