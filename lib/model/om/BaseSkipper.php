...
abstract class BaseSkipper extends BaseObject  implements Persistent
{
  ...
  const PEER = 'SkipperPeer';
	 ...
	 * actually need in Skipper.
	 */
	public function getGeneralInfosJoinsfGuardUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('GeneralInfo.sfGuardUser', $join_behavior);
