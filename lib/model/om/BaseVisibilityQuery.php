...
abstract class BaseVisibilityQuery extends ModelCriteria
{
	 ...
	 * @return    VisibilityQuery The current query, for fluid interface
	 */
	public function filterByVisibilityI18n($visibilityI18n)
	{
		return $this
			->addUsingAlias(VisibilityPeer::ID, $visibilityI18n->getId(), Criteria::EQUAL);
	}
	 ...
	 */
	public function useVisibilityI18nQuery($relationAlias = '', $joinType = Criteria::INNER_JOIN)
	{
		return $this
			->join('VisibilityI18n' . ($relationAlias ? ' ' . $relationAlias : ''), $joinType)
