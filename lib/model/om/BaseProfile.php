...
abstract class BaseProfile extends BaseObject  implements Persistent
{
  ...
  const PEER = 'ProfilePeer';
	...
	/**
	 * @var        array ProfileI18n[] Collection to store aggregation of ProfileI18n objects.
	 */
	...
	public function setSlug($v)
	{
		...
		if ($this->slug !== $v) {
			$this->slug = $v;
			$this->modifiedColumns[] = ProfilePeer::SLUG;
		}
	...
	public function setPhoto($v)
	{
		...
		if ($this->photo !== $v) {
			$this->photo = $v;
			$this->modifiedColumns[] = ProfilePeer::PHOTO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = ProfilePeer::NUM_COLUMNS - ProfilePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProfilePeer::SLUG)) $criteria->add(ProfilePeer::SLUG, $this->slug);
		if ($this->isColumnModified(ProfilePeer::NAME)) $criteria->add(ProfilePeer::NAME, $this->name);
		if ($this->isColumnModified(ProfilePeer::PHOTO)) $criteria->add(ProfilePeer::PHOTO, $this->photo);
	...
	{
		$this->collProfileI18ns = new PropelObjectCollection();
		$this->collProfileI18ns->setModel('ProfileI18n');
	}

	/**
	 * Gets an array of ProfileI18n objects which contain a foreign key that references this object.
	 *
	 ...
	 * @param      PropelPDO $con
	 * @return     PropelCollection|array ProfileI18n[] List of ProfileI18n objects
	 * @throws     PropelException
	 */
	public function getProfileI18ns($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collProfileI18ns || null !== $criteria) {
			if ($this->isNew() && null === $this->collProfileI18ns) {
				// return empty collection
				$this->initProfileI18ns();
			} else {
				$collProfileI18ns = ProfileI18nQuery::create(null, $criteria)
	 ...
	 * @throws     PropelException
	 */
	public function countProfileI18ns(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collProfileI18ns || null !== $criteria) {
			if ($this->isNew() && null === $this->collProfileI18ns) {
				return 0;
			} else {
				$query = ProfileI18nQuery::create(null, $criteria);
				if($distinct) {
					$query->distinct();
				}
				return $query
	...
	/**
	 * Method called to associate a ProfileI18n object to this object
	 * through the ProfileI18n foreign key attribute.
	 *
	 * @param      ProfileI18n $l ProfileI18n
	 * @return     void
	 * @throws     PropelException
	 */
	public function addProfileI18n(ProfileI18n $l)
	{
		...
		if (!$this->collProfileI18ns->contains($l)) { // only add it if the **same** object is not already associated
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collProfileI18ns) {
				foreach ((array) $this->collProfileI18ns as $o) {
	...
	/**
	 * Returns the "type" value from the current {@link ProfileI18n}.
	 */
	public function getType($culture = null)
	{
	  return $this->getCurrentProfileI18n($culture)->getType();
	}
	
	/**
	 * Sets the "type" value of the current {@link ProfileI18n}.
	 *
	 * @return Profile
	 */
	public function setType($value, $culture = null)
	{
	  $this->getCurrentProfileI18n($culture)->setType($value);
	  return $this;
	}
	
	/**
	 * Returns the "about" value from the current {@link ProfileI18n}.
	 */
	public function getAbout($culture = null)
	{
	  return $this->getCurrentProfileI18n($culture)->getAbout();
	}
	
	/**
	 * Sets the "about" value of the current {@link ProfileI18n}.
	 *
	 * @return Profile
	 */
	public function setAbout($value, $culture = null)
	{
	  $this->getCurrentProfileI18n($culture)->setAbout($value);
	  return $this;
	}
	...
	public function getCurrentProfileI18n($culture = null)
	{
	  ...
	  {
	    $object = $this->isNew() ? null : ProfileI18nPeer::retrieveByPK($this->getPrimaryKey(), $culture);
	    if ($object)
	    {
	      $this->setProfileI18nForCulture($object, $culture);
	    }
	    else
	    {
	 ...
	 */
	public function setProfileI18nForCulture(ProfileI18n $object, $culture)
	{
