...
abstract class BaseRecord extends BaseObject  implements Persistent {
	...
	public function setComments($v)
	{
		...
		if ($this->comments !== $v) {
			$this->comments = $v;
			$this->modifiedColumns[] = RecordPeer::COMMENTS;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 9; // 9 = RecordPeer::NUM_COLUMNS - RecordPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RecordPeer::COMMENTS)) $criteria->add(RecordPeer::COMMENTS, $this->comments);
	...
	public function getCode(PropelPDO $con = null)
	{
		if ($this->aCode === null && ($this->code_id !== null)) {
			$this->aCode = CodePeer::retrieveByPk($this->code_id);
	...
	public function getVisibility(PropelPDO $con = null)
	{
		if ($this->aVisibility === null && ($this->visibility_id !== null)) {
			$this->aVisibility = VisibilityPeer::retrieveByPk($this->visibility_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
	...
	public function getSeaState(PropelPDO $con = null)
	{
		if ($this->aSeaState === null && ($this->sea_state_id !== null)) {
			$this->aSeaState = SeaStatePeer::retrieveByPk($this->sea_state_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
	...
	public function getGeneralInfo(PropelPDO $con = null)
	{
		if ($this->aGeneralInfo === null && ($this->general_info_id !== null)) {
			$this->aGeneralInfo = GeneralInfoPeer::retrieveByPk($this->general_info_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
	 ...
	 * Otherwise if this Record has previously been saved, it will retrieve
	 * related Sightings from storage. If this Record is new, it will return
		...
		if ($this->collSightings === null) {
			if ($this->isNew()) {
			   $this->collSightings = array();
				...
				$criteria->add(SightingPeer::RECORD_ID, $this->id);
	...
	public function getSightingsJoinSpecie($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		if ($this->collSightings === null) {
			if ($this->isNew()) {
				...
				$this->collSightings = SightingPeer::doSelectJoinSpecie($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
