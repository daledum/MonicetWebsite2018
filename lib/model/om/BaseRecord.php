  ...
  const PEER = 'RecordPeer';
	...
	public function setCompanyId($v)
	{
		...
		if ($this->company_id !== $v) {
			$this->company_id = $v;
			$this->modifiedColumns[] = RecordPeer::COMPANY_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->latitude = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->longitude = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			...
			return $startcol + 12; // 12 = RecordPeer::NUM_COLUMNS - RecordPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RecordPeer::COMPANY_ID)) $criteria->add(RecordPeer::COMPANY_ID, $this->company_id);
	...
	public function getCode(PropelPDO $con = null)
	{
		if ($this->aCode === null && ($this->code_id !== null)) {
			$this->aCode = CodeQuery::create()->findPk($this->code_id);
	...
	public function getVisibility(PropelPDO $con = null)
	{
		if ($this->aVisibility === null && ($this->visibility_id !== null)) {
			$this->aVisibility = VisibilityQuery::create()->findPk($this->visibility_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
	...
	public function getSeaState(PropelPDO $con = null)
	{
		if ($this->aSeaState === null && ($this->sea_state_id !== null)) {
			$this->aSeaState = SeaStateQuery::create()->findPk($this->sea_state_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
	...
	public function getGeneralInfo(PropelPDO $con = null)
	{
		if ($this->aGeneralInfo === null && ($this->general_info_id !== null)) {
			$this->aGeneralInfo = GeneralInfoQuery::create()->findPk($this->general_info_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
	...
	{
		$query = SightingQuery::create(null, $criteria);
		$query->joinWith('Sighting.Association', $join_behavior);
