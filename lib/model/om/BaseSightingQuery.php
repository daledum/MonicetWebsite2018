...
abstract class BaseSightingQuery extends ModelCriteria
{
	 ...
	 * @return    SightingQuery The current query, for fluid interface
	 */
	public function filterByCalves($calves = null)
	{
		if(preg_match('/[\%\*]/', $calves)) {
			return $this->addUsingAlias(SightingPeer::CALVES, str_replace('*', '%', $calves), Criteria::LIKE);
		} else {
			return $this->addUsingAlias(SightingPeer::CALVES, $calves, Criteria::EQUAL);
		}
	}
