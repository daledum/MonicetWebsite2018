 ...
 *
 * @method     VisibilityI18nQuery leftJoin($relation) Adds a LEFT JOIN clause to the query
 * @method     VisibilityI18nQuery rightJoin($relation) Adds a RIGHT JOIN clause to the query
 * @method     VisibilityI18nQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     VisibilityI18nQuery leftJoinVisibility($relationAlias = null) Adds a LEFT JOIN clause to the query using the Visibility relation
 * @method     VisibilityI18nQuery rightJoinVisibility($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Visibility relation
 * @method     VisibilityI18nQuery innerJoinVisibility($relationAlias = null) Adds a INNER JOIN clause to the query using the Visibility relation
 *
 * @method     VisibilityI18n findOne(PropelPDO $con = null) Return the first VisibilityI18n matching the query
 * @method     VisibilityI18n findOneOrCreate(PropelPDO $con = null) Return the first VisibilityI18n matching the query, or a new VisibilityI18n object populated from the query conditions when no match is found
 *
...
abstract class BaseVisibilityI18nQuery extends ModelCriteria
{
	 ...
	 *
	 * @return    VisibilityI18n|array|mixed the result, formatted by the current formatter
	 */
	public function findPk($key, $con = null)
	{
		if ((null !== ($obj = VisibilityI18nPeer::getInstanceFromPool(serialize(array((string) $key[0], (string) $key[1]))))) && $this->getFormatter()->isObjectFormatter()) {
	...
	public function filterById($id = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(VisibilityI18nPeer::ID, $id, $comparison);
	}
	...
	public function filterByCulture($culture = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(VisibilityI18nPeer::CULTURE, $culture, $comparison);
	}
	...
	public function filterByDescription($description = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(VisibilityI18nPeer::DESCRIPTION, $description, $comparison);
	}
	...
	{
		return $this
			->addUsingAlias(VisibilityI18nPeer::ID, $visibility->getId(), $comparison);
	}
