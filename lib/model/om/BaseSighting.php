...
abstract class BaseSighting extends BaseObject  implements Persistent
{
  ...
  const PEER = 'SightingPeer';
	...
	/**
	 * Initializes internal state of BaseSighting object.
	 * @see        applyDefaults()
	 */
	...
	public function setJuveniles($v)
	{
		...
		if ($this->juveniles !== $v || $this->isNew()) {
			$this->juveniles = $v;
	...
	public function setNumVessels($v)
	{
		...
		if ($this->num_vessels !== $v || $this->isNew()) {
			$this->num_vessels = $v;
			$this->modifiedColumns[] = SightingPeer::NUM_VESSELS;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = SightingPeer::DESCRIPTION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->num_vessels = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[9], $arr)) $this->setNumVessels($arr[$keys[9]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SightingPeer::NUM_VESSELS)) $criteria->add(SightingPeer::NUM_VESSELS, $this->num_vessels);
		if ($this->isColumnModified(SightingPeer::DESCRIPTION)) $criteria->add(SightingPeer::DESCRIPTION, $this->description);
