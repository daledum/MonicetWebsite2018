 ...
 * @method     Record findOneByLatitude(double $latitude) Return the first Record filtered by the latitude column
 * @method     Record findOneByLongitude(double $longitude) Return the first Record filtered by the longitude column
 ...
 * @method     array findByLatitude(double $latitude) Return Record objects filtered by the latitude column
 * @method     array findByLongitude(double $longitude) Return Record objects filtered by the longitude column
...
abstract class BaseRecordQuery extends ModelCriteria
{
	...
	public function filterByLatitude($latitude = null)
	{
		if (is_array($latitude)) {
			if (array_values($latitude) === $latitude) {
				return $this->addUsingAlias(RecordPeer::LATITUDE, $latitude, Criteria::IN);
			} else {
				if (isset($latitude['min'])) {
					$this->addUsingAlias(RecordPeer::LATITUDE, $latitude['min'], Criteria::GREATER_EQUAL);
				}
				if (isset($latitude['max'])) {
					$this->addUsingAlias(RecordPeer::LATITUDE, $latitude['max'], Criteria::LESS_EQUAL);
				}
				return $this;	
			}
		} else {
	...
	public function filterByLongitude($longitude = null)
	{
		if (is_array($longitude)) {
			if (array_values($longitude) === $longitude) {
				return $this->addUsingAlias(RecordPeer::LONGITUDE, $longitude, Criteria::IN);
			} else {
				if (isset($longitude['min'])) {
					$this->addUsingAlias(RecordPeer::LONGITUDE, $longitude['min'], Criteria::GREATER_EQUAL);
				}
				if (isset($longitude['max'])) {
					$this->addUsingAlias(RecordPeer::LONGITUDE, $longitude['max'], Criteria::LESS_EQUAL);
				}
				return $this;	
			}
		} else {
	...
	public function filterByNumVessels($numVessels = null)
	{
		if (is_array($numVessels)) {
			if (array_values($numVessels) === $numVessels) {
				return $this->addUsingAlias(RecordPeer::NUM_VESSELS, $numVessels, Criteria::IN);
			} else {
			...
			return $this->addUsingAlias(RecordPeer::NUM_VESSELS, $numVessels, Criteria::EQUAL);
		}
	}
