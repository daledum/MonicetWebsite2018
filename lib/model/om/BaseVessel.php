...
abstract class BaseVessel extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = VesselPeer::NUM_COLUMNS - VesselPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = VesselPeer::doInsert($this, $con);
	 ...
	 * Otherwise if this Vessel has previously been saved, it will retrieve
	 * related GeneralInfos from storage. If this Vessel is new, it will return
		...
		if ($this->collGeneralInfos === null) {
			if ($this->isNew()) {
			   $this->collGeneralInfos = array();
				...
				$criteria->add(GeneralInfoPeer::VESSEL_ID, $this->id);
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseVessel:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseVessel::%s', $method));
	  }
