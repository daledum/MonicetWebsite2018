  ...
  const PEER = 'VesselPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->length = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->power = ($row[$startcol + 4] !== null) ? (double) $row[$startcol + 4] : null;
			...
			return $startcol + 9; // 9 = VesselPeer::NUM_COLUMNS - VesselPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setPower($arr[$keys[4]]);
