...
class CompanyTableMap extends TableMap {
	...
	{
    $this->addRelation('Guide', 'Guide', RelationMap::ONE_TO_MANY, array('id' => 'company_id', ), null, null);
    $this->addRelation('Skipper', 'Skipper', RelationMap::ONE_TO_MANY, array('id' => 'company_id', ), null, null);
