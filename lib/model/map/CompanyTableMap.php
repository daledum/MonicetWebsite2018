...
class CompanyTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('COUNCIL', 'Council', 'VARCHAR', false, 255, null);
	...
	{
    $this->addRelation('CompanyUser', 'CompanyUser', RelationMap::ONE_TO_MANY, array('id' => 'company_id', ), null, null);
    $this->addRelation('Vessel', 'Vessel', RelationMap::ONE_TO_MANY, array('id' => 'company_id', ), null, null);
    $this->addRelation('Record', 'Record', RelationMap::ONE_TO_MANY, array('id' => 'company_id', ), null, null);
	} // buildRelations()
