...
class SpecieTableMap extends TableMap {
	...
	{
    $this->addRelation('SpecieGroup', 'SpecieGroup', RelationMap::MANY_TO_ONE, array('specie_group_id' => 'id', ), null, null);
    $this->addRelation('Sighting', 'Sighting', RelationMap::ONE_TO_MANY, array('id' => 'specie_id', ), null, null);
	} // buildRelations()
