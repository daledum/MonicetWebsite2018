...
class WatchSightingTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('WATCH_VISIBILITY_ID', 'WatchVisibilityId', 'INTEGER', 'watch_visibility', 'ID', true, null, null);
		...
		$this->addForeignKey('WATCH_BEHAVIOUR_ID', 'WatchBehaviourId', 'INTEGER', 'watch_behaviour', 'ID', false, null, null);
		$this->addForeignKey('DIRECTION_ID', 'DirectionId', 'INTEGER', 'direction', 'ID', true, null, null);
		$this->addColumn('HORIZONTAL', 'Horizontal', 'FLOAT', true, null, null);
		$this->addColumn('VERTICAL', 'Vertical', 'FLOAT', true, null, null);
    ...
    $this->addRelation('WatchBehaviour', 'WatchBehaviour', RelationMap::MANY_TO_ONE, array('watch_behaviour_id' => 'id', ), 'CASCADE', null);
