...
class VesselTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('POWER', 'Power', 'FLOAT', false, null, null);
    ...
    $this->addRelation('WatchSighting', 'WatchSighting', RelationMap::ONE_TO_MANY, array('id' => 'vessel_id', ), null, null);
    $this->addRelation('ObservationPhoto', 'ObservationPhoto', RelationMap::ONE_TO_MANY, array('id' => 'vessel_id', ), 'SET NULL', null);
	} // buildRelations()
