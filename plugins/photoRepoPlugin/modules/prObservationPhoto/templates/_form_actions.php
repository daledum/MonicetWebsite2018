<ul class="sf_admin_actions">
  ...
  <li class="sf_admin_action_back"><a href="<?php echo url_for('@pr_observation_photo'.(($form->getObject()->getStatus() == ObservationPhoto::V_SIGLA)? '_validated': '')) ?>">Regressar à listagem</a></li>
  <?php if ($form->isNew()): ?>
