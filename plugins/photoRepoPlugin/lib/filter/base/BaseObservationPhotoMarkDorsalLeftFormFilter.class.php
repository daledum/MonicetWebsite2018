...
/**
 * ObservationPhotoMarkDorsalLeft filter form base class.
 *
 * @package    ##PROJECT_NAME##
 * @subpackage filter
 * @author     ##AUTHOR_NAME##
 */
abstract class BaseObservationPhotoMarkDorsalLeftFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('observation_photo_mark_dorsal_left_filters[%s]');
