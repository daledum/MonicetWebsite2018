...
abstract class BasePatternFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'columns_dorsal_left'  => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'columns_dorsal_left'  => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
