...
/**
 * This class defines the structure of the 'observation_photo_mark_tail' table.
 *
 *
 ...
 */
class ObservationPhotoMarkTailTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'plugins.photoRepoPlugin.lib.model.map.ObservationPhotoMarkTailTableMap';
	...
	{
	  // attributes
		$this->setName('observation_photo_mark_tail');
		$this->setPhpName('ObservationPhotoMarkTail');
		$this->setClassname('ObservationPhotoMarkTail');
...
} // ObservationPhotoMarkTailTableMap
