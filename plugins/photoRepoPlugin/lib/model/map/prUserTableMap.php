...
/**
 * This class defines the structure of the 'pr_user' table.
 *
 *
 *
 ...
 */
class prUserTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'plugins.photoRepoPlugin.lib.model.map.prUserTableMap';
	...
	{
	  // attributes
		$this->setName('pr_user');
		$this->setPhpName('prUser');
		$this->setClassname('prUser');
