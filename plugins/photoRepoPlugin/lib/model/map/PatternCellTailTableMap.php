...
/**
 * This class defines the structure of the 'pattern_cell_tail' table.
 *
 *
 *
 ...
 */
class PatternCellTailTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'plugins.photoRepoPlugin.lib.model.map.PatternCellTailTableMap';
	...
	{
	  // attributes
		$this->setName('pattern_cell_tail');
		$this->setPhpName('PatternCellTail');
		$this->setClassname('PatternCellTail');
    ...
    $this->addRelation('ObservationPhotoTailMarkRelatedByToCellId', 'ObservationPhotoTailMark', RelationMap::ONE_TO_MANY, array('id' => 'to_cell_id', ), 'SET NULL', null);
	} // buildRelations()
