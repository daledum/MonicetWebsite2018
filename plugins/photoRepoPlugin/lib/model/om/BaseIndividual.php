...
abstract class BaseIndividual extends BaseObject  implements Persistent
{
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = IndividualPeer::NUM_COLUMNS - IndividualPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	/**
	 * Returns the "name" value from the current {@link IndividualI18n}.
	 */
	public function getName($culture = null)
	{
	  return $this->getCurrentIndividualI18n($culture)->getName();
	}
	
	/**
	 * Sets the "name" value of the current {@link IndividualI18n}.
	 *
	 * @return Individual
	 */
	public function setName($value, $culture = null)
	{
	  $this->getCurrentIndividualI18n($culture)->setName($value);
	  return $this;
	}
	
	/**
	 * Returns the "description" value from the current {@link IndividualI18n}.
	 */
	public function getDescription($culture = null)
	{
	  return $this->getCurrentIndividualI18n($culture)->getDescription();
	}
	
	/**
	 * Sets the "description" value of the current {@link IndividualI18n}.
	 *
	 * @return Individual
	 */
	public function setDescription($value, $culture = null)
	{
	  $this->getCurrentIndividualI18n($culture)->setDescription($value);
	  return $this;
	}
