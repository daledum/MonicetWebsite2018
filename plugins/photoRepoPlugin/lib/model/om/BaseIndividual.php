...
abstract class BaseIndividual extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the dominant_body_part_code field.
	 * @var        string
	 */
	protected $dominant_body_part_code;
	...
	/**
	 * Get the [dominant_body_part_code] column value.
	 * 
	 * @return     string
	 */
	public function getDominantBodyPartCode()
	{
		return $this->dominant_body_part_code;
	}
	...
	/**
	 * Set the value of [dominant_body_part_code] column.
	 * 
	 * @param      string $v new value
	 * @return     Individual The current object (for fluent API support)
	 */
	public function setDominantBodyPartCode($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->dominant_body_part_code !== $v) {
			$this->dominant_body_part_code = $v;
			$this->modifiedColumns[] = IndividualPeer::DOMINANT_BODY_PART_CODE;
		}

		return $this;
	} // setDominantBodyPartCode()
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->dominant_body_part_code = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 6; // 6 = IndividualPeer::NUM_COLUMNS - IndividualPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				return $this->getDominantBodyPartCode();
				break;
			case 3:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
			$keys[2] => $this->getDominantBodyPartCode(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				$this->setDominantBodyPartCode($value);
				break;
			case 3:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setDominantBodyPartCode($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(IndividualPeer::DOMINANT_BODY_PART_CODE)) $criteria->add(IndividualPeer::DOMINANT_BODY_PART_CODE, $this->dominant_body_part_code);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setDominantBodyPartCode($this->dominant_body_part_code);
	...
	public function clear()
	{
		$this->id = null;
		$this->name = null;
		$this->dominant_body_part_code = null;
		$this->specie_id = null;
