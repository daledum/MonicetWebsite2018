...
abstract class BasePhotographer extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the cpoyright field.
	 * @var        string
	 */
	protected $cpoyright;
	...
	/**
	 * Get the [cpoyright] column value.
	 * 
	 * @return     string
	 */
	public function getCpoyright()
	{
		return $this->cpoyright;
	}
	...
	/**
	 * Set the value of [cpoyright] column.
	 * 
	 * @param      string $v new value
	 * @return     Photographer The current object (for fluent API support)
	 */
	public function setCpoyright($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->cpoyright !== $v) {
			$this->cpoyright = $v;
			$this->modifiedColumns[] = PhotographerPeer::CPOYRIGHT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->cpoyright = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setCpoyright($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PhotographerPeer::CPOYRIGHT)) $criteria->add(PhotographerPeer::CPOYRIGHT, $this->cpoyright);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCpoyright($this->cpoyright);
