...
/**
 * Base class that represents a row from the 'observation_photo_mark_dorsal_right' table.
 *
 * 
 *
 ...
 */
abstract class BaseObservationPhotoMarkDorsalRight extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'ObservationPhotoMarkDorsalRightPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        ObservationPhotoMarkDorsalRightPeer
	 */
	 ...
	 * @return     ObservationPhotoMarkDorsalRight The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ObservationPhotoMarkDorsalRightPeer::ID;
		}
	...
	public function setPhotoId($v)
	{
		...
		if ($this->photo_id !== $v) {
			$this->photo_id = $v;
			$this->modifiedColumns[] = ObservationPhotoMarkDorsalRightPeer::PHOTO_ID;
		}
	...
	public function setMarkId($v)
	{
		...
		if ($this->mark_id !== $v) {
			$this->mark_id = $v;
			$this->modifiedColumns[] = ObservationPhotoMarkDorsalRightPeer::MARK_ID;
		}
	...
	public function setLine($v)
	{
		...
		if ($this->line !== $v) {
			$this->line = $v;
			$this->modifiedColumns[] = ObservationPhotoMarkDorsalRightPeer::LINE;
		}
	...
	public function setColumn($v)
	{
		...
		if ($this->column !== $v) {
			$this->column = $v;
			$this->modifiedColumns[] = ObservationPhotoMarkDorsalRightPeer::COLUMN;
		}
	...
	public function setObservation($v)
	{
		...
		if ($this->observation !== $v) {
			$this->observation = $v;
			$this->modifiedColumns[] = ObservationPhotoMarkDorsalRightPeer::OBSERVATION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = ObservationPhotoMarkDorsalRightPeer::NUM_COLUMNS - ObservationPhotoMarkDorsalRightPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ObservationPhotoMarkDorsalRight object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ObservationPhotoMarkDorsalRightPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseObservationPhotoMarkDorsalRight:delete:pre') as $callable)
			{
			...
			if ($ret) {
				ObservationPhotoMarkDorsalRightQuery::create()
					->filterByPrimaryKey($this->getPrimaryKey())
					->delete($con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseObservationPhotoMarkDorsalRight:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseObservationPhotoMarkDorsalRight:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseObservationPhotoMarkDorsalRight:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				ObservationPhotoMarkDorsalRightPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(ObservationPhotoMarkDorsalRightPeer::ID) ) {
					...
					$affectedRows += ObservationPhotoMarkDorsalRightPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ObservationPhotoMarkDorsalRightPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ObservationPhotoMarkDorsalRightPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ObservationPhotoMarkDorsalRightPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ObservationPhotoMarkDorsalRightPeer::ID)) $criteria->add(ObservationPhotoMarkDorsalRightPeer::ID, $this->id);
		if ($this->isColumnModified(ObservationPhotoMarkDorsalRightPeer::PHOTO_ID)) $criteria->add(ObservationPhotoMarkDorsalRightPeer::PHOTO_ID, $this->photo_id);
		if ($this->isColumnModified(ObservationPhotoMarkDorsalRightPeer::MARK_ID)) $criteria->add(ObservationPhotoMarkDorsalRightPeer::MARK_ID, $this->mark_id);
		if ($this->isColumnModified(ObservationPhotoMarkDorsalRightPeer::LINE)) $criteria->add(ObservationPhotoMarkDorsalRightPeer::LINE, $this->line);
		if ($this->isColumnModified(ObservationPhotoMarkDorsalRightPeer::COLUMN)) $criteria->add(ObservationPhotoMarkDorsalRightPeer::COLUMN, $this->column);
		if ($this->isColumnModified(ObservationPhotoMarkDorsalRightPeer::OBSERVATION)) $criteria->add(ObservationPhotoMarkDorsalRightPeer::OBSERVATION, $this->observation);
	...
	{
		$criteria = new Criteria(ObservationPhotoMarkDorsalRightPeer::DATABASE_NAME);
		$criteria->add(ObservationPhotoMarkDorsalRightPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ObservationPhotoMarkDorsalRight (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ObservationPhotoMarkDorsalRight Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ObservationPhotoMarkDorsalRightPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ObservationPhotoMarkDorsalRightPeer();
		}
		return self::$peer;
	}
	...
	public function setObservationPhoto(ObservationPhoto $v = null)
	{
		...
		if ($v !== null) {
			$v->addObservationPhotoMarkDorsalRight($this);
		}
	...
	public function getObservationPhoto(PropelPDO $con = null)
	{
		if ($this->aObservationPhoto === null && ($this->photo_id !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 $this->aObservationPhoto->addObservationPhotoMarkDorsalRights($this);
			 */
		}
	...
	public function getMark(PropelPDO $con = null)
	{
		if ($this->aMark === null && ($this->mark_id !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 undesirable since it could result in an only partially populated collection
				 in the referenced object.
				 $this->aMark->addObservationPhotoMarkDorsalRights($this);
			 */
		}
		return $this->aMark;
	}
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseObservationPhotoMarkDorsalRight:' . $name))
		{
...
} // BaseObservationPhotoMarkDorsalRight
