 ...
 *
 * @method     PatternCellTailQuery leftJoinObservationPhotoTailMarkRelatedByPatternCellTailId($relationAlias = null) Adds a LEFT JOIN clause to the query using the ObservationPhotoTailMarkRelatedByPatternCellTailId relation
...
abstract class BasePatternCellTailQuery extends ModelCriteria
{
	 ...
	 * @return    PatternCellTailQuery The current query, for fluid interface
	 */
	public function filterByObservationPhotoTailMarkRelatedByPatternCellTailId($observationPhotoTailMark, $comparison = null)
	{
		return $this
			->addUsingAlias(PatternCellTailPeer::ID, $observationPhotoTailMark->getPatternCellTailId(), $comparison);
	}

	/**
	 * Adds a JOIN clause to the query using the ObservationPhotoTailMarkRelatedByPatternCellTailId relation
	 * 
	 * @param     string $relationAlias optional alias for the relation
	 * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
	 *
	 * @return    PatternCellTailQuery The current query, for fluid interface
	 */
	public function joinObservationPhotoTailMarkRelatedByPatternCellTailId($relationAlias = null, $joinType = Criteria::INNER_JOIN)
	{
		$tableMap = $this->getTableMap();
		$relationMap = $tableMap->getRelation('ObservationPhotoTailMarkRelatedByPatternCellTailId');
		...
		if($relationAlias) {
			...
			$this->addJoinObject($join, 'ObservationPhotoTailMarkRelatedByPatternCellTailId');
		}
	...
	/**
	 * Use the ObservationPhotoTailMarkRelatedByPatternCellTailId relation ObservationPhotoTailMark object
	 *
	 * @see       useQuery()
	 * 
	 * @param     string $relationAlias optional alias for the relation,
	 ...
	 */
	public function useObservationPhotoTailMarkRelatedByPatternCellTailIdQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
	{
		return $this
			->joinObservationPhotoTailMarkRelatedByPatternCellTailId($relationAlias, $joinType)
			->useQuery($relationAlias ? $relationAlias : 'ObservationPhotoTailMarkRelatedByPatternCellTailId', 'ObservationPhotoTailMarkQuery');
	}
