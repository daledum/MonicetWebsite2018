...
/**
 * Base class that represents a row from the 'observation_photo_mark_dorsal_left' table.
 *
 * 
 *
 ...
 */
abstract class BaseObservationPhotoMarkDorsalLeft extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'ObservationPhotoMarkDorsalLeftPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        ObservationPhotoMarkDorsalLeftPeer
	 */
	 ...
	 * @return     ObservationPhotoMarkDorsalLeft The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ObservationPhotoMarkDorsalLeftPeer::ID;
		}
	...
	public function setPhotoId($v)
	{
		...
		if ($this->photo_id !== $v) {
			$this->photo_id = $v;
			$this->modifiedColumns[] = ObservationPhotoMarkDorsalLeftPeer::PHOTO_ID;
		}
	...
	public function setMarkId($v)
	{
		...
		if ($this->mark_id !== $v) {
			$this->mark_id = $v;
			$this->modifiedColumns[] = ObservationPhotoMarkDorsalLeftPeer::MARK_ID;
		}
	...
	public function setLine($v)
	{
		...
		if ($this->line !== $v) {
			$this->line = $v;
			$this->modifiedColumns[] = ObservationPhotoMarkDorsalLeftPeer::LINE;
		}
	...
	public function setColumn($v)
	{
		...
		if ($this->column !== $v) {
			$this->column = $v;
			$this->modifiedColumns[] = ObservationPhotoMarkDorsalLeftPeer::COLUMN;
		}
	...
	public function setObservation($v)
	{
		...
		if ($this->observation !== $v) {
			$this->observation = $v;
			$this->modifiedColumns[] = ObservationPhotoMarkDorsalLeftPeer::OBSERVATION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = ObservationPhotoMarkDorsalLeftPeer::NUM_COLUMNS - ObservationPhotoMarkDorsalLeftPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ObservationPhotoMarkDorsalLeft object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ObservationPhotoMarkDorsalLeftPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseObservationPhotoMarkDorsalLeft:delete:pre') as $callable)
			{
			...
			if ($ret) {
				ObservationPhotoMarkDorsalLeftQuery::create()
					->filterByPrimaryKey($this->getPrimaryKey())
					->delete($con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseObservationPhotoMarkDorsalLeft:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseObservationPhotoMarkDorsalLeft:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseObservationPhotoMarkDorsalLeft:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				ObservationPhotoMarkDorsalLeftPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(ObservationPhotoMarkDorsalLeftPeer::ID) ) {
					...
					$affectedRows += ObservationPhotoMarkDorsalLeftPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ObservationPhotoMarkDorsalLeftPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ObservationPhotoMarkDorsalLeftPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ObservationPhotoMarkDorsalLeftPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ObservationPhotoMarkDorsalLeftPeer::ID)) $criteria->add(ObservationPhotoMarkDorsalLeftPeer::ID, $this->id);
		if ($this->isColumnModified(ObservationPhotoMarkDorsalLeftPeer::PHOTO_ID)) $criteria->add(ObservationPhotoMarkDorsalLeftPeer::PHOTO_ID, $this->photo_id);
		if ($this->isColumnModified(ObservationPhotoMarkDorsalLeftPeer::MARK_ID)) $criteria->add(ObservationPhotoMarkDorsalLeftPeer::MARK_ID, $this->mark_id);
		if ($this->isColumnModified(ObservationPhotoMarkDorsalLeftPeer::LINE)) $criteria->add(ObservationPhotoMarkDorsalLeftPeer::LINE, $this->line);
		if ($this->isColumnModified(ObservationPhotoMarkDorsalLeftPeer::COLUMN)) $criteria->add(ObservationPhotoMarkDorsalLeftPeer::COLUMN, $this->column);
		if ($this->isColumnModified(ObservationPhotoMarkDorsalLeftPeer::OBSERVATION)) $criteria->add(ObservationPhotoMarkDorsalLeftPeer::OBSERVATION, $this->observation);
	...
	{
		$criteria = new Criteria(ObservationPhotoMarkDorsalLeftPeer::DATABASE_NAME);
		$criteria->add(ObservationPhotoMarkDorsalLeftPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ObservationPhotoMarkDorsalLeft (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ObservationPhotoMarkDorsalLeft Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ObservationPhotoMarkDorsalLeftPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ObservationPhotoMarkDorsalLeftPeer();
		}
		return self::$peer;
	}
	...
	public function setObservationPhoto(ObservationPhoto $v = null)
	{
		...
		if ($v !== null) {
			$v->addObservationPhotoMarkDorsalLeft($this);
		}
	...
	public function getObservationPhoto(PropelPDO $con = null)
	{
		if ($this->aObservationPhoto === null && ($this->photo_id !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 $this->aObservationPhoto->addObservationPhotoMarkDorsalLefts($this);
			 */
		}
	...
	public function getMark(PropelPDO $con = null)
	{
		if ($this->aMark === null && ($this->mark_id !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 undesirable since it could result in an only partially populated collection
				 in the referenced object.
				 $this->aMark->addObservationPhotoMarkDorsalLefts($this);
			 */
		}
		return $this->aMark;
	}
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseObservationPhotoMarkDorsalLeft:' . $name))
		{
...
} // BaseObservationPhotoMarkDorsalLeft
