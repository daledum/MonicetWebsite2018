...
/**
 * Base class that represents a row from the 'observation_photo_mark_tail' table.
 *
 * 
 *
 ...
 */
abstract class BaseObservationPhotoMarkTail extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'ObservationPhotoMarkTailPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        ObservationPhotoMarkTailPeer
	 */
	 ...
	 * @return     ObservationPhotoMarkTail The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ObservationPhotoMarkTailPeer::ID;
		}
	...
	public function setPhotoId($v)
	{
		...
		if ($this->photo_id !== $v) {
			$this->photo_id = $v;
			$this->modifiedColumns[] = ObservationPhotoMarkTailPeer::PHOTO_ID;
		}
	...
	public function setMarkId($v)
	{
		...
		if ($this->mark_id !== $v) {
			$this->mark_id = $v;
			$this->modifiedColumns[] = ObservationPhotoMarkTailPeer::MARK_ID;
		}
	...
	public function setLine($v)
	{
		...
		if ($this->line !== $v) {
			$this->line = $v;
			$this->modifiedColumns[] = ObservationPhotoMarkTailPeer::LINE;
		}
	...
	public function setColumn($v)
	{
		...
		if ($this->column !== $v) {
			$this->column = $v;
			$this->modifiedColumns[] = ObservationPhotoMarkTailPeer::COLUMN;
		}
	...
	public function setObservation($v)
	{
		...
		if ($this->observation !== $v) {
			$this->observation = $v;
			$this->modifiedColumns[] = ObservationPhotoMarkTailPeer::OBSERVATION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = ObservationPhotoMarkTailPeer::NUM_COLUMNS - ObservationPhotoMarkTailPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ObservationPhotoMarkTail object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ObservationPhotoMarkTailPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseObservationPhotoMarkTail:delete:pre') as $callable)
			{
			...
			if ($ret) {
				ObservationPhotoMarkTailQuery::create()
					->filterByPrimaryKey($this->getPrimaryKey())
					->delete($con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseObservationPhotoMarkTail:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseObservationPhotoMarkTail:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseObservationPhotoMarkTail:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				ObservationPhotoMarkTailPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(ObservationPhotoMarkTailPeer::ID) ) {
					...
					$affectedRows += ObservationPhotoMarkTailPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ObservationPhotoMarkTailPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ObservationPhotoMarkTailPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ObservationPhotoMarkTailPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ObservationPhotoMarkTailPeer::ID)) $criteria->add(ObservationPhotoMarkTailPeer::ID, $this->id);
		if ($this->isColumnModified(ObservationPhotoMarkTailPeer::PHOTO_ID)) $criteria->add(ObservationPhotoMarkTailPeer::PHOTO_ID, $this->photo_id);
		if ($this->isColumnModified(ObservationPhotoMarkTailPeer::MARK_ID)) $criteria->add(ObservationPhotoMarkTailPeer::MARK_ID, $this->mark_id);
		if ($this->isColumnModified(ObservationPhotoMarkTailPeer::LINE)) $criteria->add(ObservationPhotoMarkTailPeer::LINE, $this->line);
		if ($this->isColumnModified(ObservationPhotoMarkTailPeer::COLUMN)) $criteria->add(ObservationPhotoMarkTailPeer::COLUMN, $this->column);
		if ($this->isColumnModified(ObservationPhotoMarkTailPeer::OBSERVATION)) $criteria->add(ObservationPhotoMarkTailPeer::OBSERVATION, $this->observation);
	...
	{
		$criteria = new Criteria(ObservationPhotoMarkTailPeer::DATABASE_NAME);
		$criteria->add(ObservationPhotoMarkTailPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ObservationPhotoMarkTail (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ObservationPhotoMarkTail Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ObservationPhotoMarkTailPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ObservationPhotoMarkTailPeer();
		}
		return self::$peer;
	}
	...
	public function setObservationPhoto(ObservationPhoto $v = null)
	{
		...
		if ($v !== null) {
			$v->addObservationPhotoMarkTail($this);
		}
	...
	public function getObservationPhoto(PropelPDO $con = null)
	{
		if ($this->aObservationPhoto === null && ($this->photo_id !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 $this->aObservationPhoto->addObservationPhotoMarkTails($this);
			 */
		}
	...
	public function getMark(PropelPDO $con = null)
	{
		if ($this->aMark === null && ($this->mark_id !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 undesirable since it could result in an only partially populated collection
				 in the referenced object.
				 $this->aMark->addObservationPhotoMarkTails($this);
			 */
		}
		return $this->aMark;
	}
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseObservationPhotoMarkTail:' . $name))
		{
