...
abstract class BaseObservationPhotoTailMarkPeer {
	...
	const TO_CELL_ID = 'observation_photo_tail_mark.TO_CELL_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ObservationPhotoTailId', 'PatternCellTailId', 'IsWide', 'IsDeep', 'ToCellId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'observationPhotoTailId', 'patternCellTailId', 'isWide', 'isDeep', 'toCellId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::OBSERVATION_PHOTO_TAIL_ID, self::PATTERN_CELL_TAIL_ID, self::IS_WIDE, self::IS_DEEP, self::TO_CELL_ID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'OBSERVATION_PHOTO_TAIL_ID', 'PATTERN_CELL_TAIL_ID', 'IS_WIDE', 'IS_DEEP', 'TO_CELL_ID', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'observation_photo_tail_id', 'pattern_cell_tail_id', 'is_wide', 'is_deep', 'to_cell_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ObservationPhotoTailId' => 1, 'PatternCellTailId' => 2, 'IsWide' => 3, 'IsDeep' => 4, 'ToCellId' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'observationPhotoTailId' => 1, 'patternCellTailId' => 2, 'isWide' => 3, 'isDeep' => 4, 'toCellId' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::OBSERVATION_PHOTO_TAIL_ID => 1, self::PATTERN_CELL_TAIL_ID => 2, self::IS_WIDE => 3, self::IS_DEEP => 4, self::TO_CELL_ID => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'OBSERVATION_PHOTO_TAIL_ID' => 1, 'PATTERN_CELL_TAIL_ID' => 2, 'IS_WIDE' => 3, 'IS_DEEP' => 4, 'TO_CELL_ID' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'observation_photo_tail_id' => 1, 'pattern_cell_tail_id' => 2, 'is_wide' => 3, 'is_deep' => 4, 'to_cell_id' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(ObservationPhotoTailMarkPeer::TO_CELL_ID);
		} else {
	...
	/**
	 * Returns the number of rows matching criteria, joining the related PatternCellTailRelatedByToCellId table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinPatternCellTailRelatedByToCellId(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(ObservationPhotoTailMarkPeer::TO_CELL_ID, PatternCellTailPeer::ID, $join_behavior);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinPatternCellTailRelatedByToCellId(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (ObservationPhotoTailMark) to $obj2 (PatternCellTail)
				$obj2->addObservationPhotoTailMarkRelatedByToCellId($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key4 !== null) {
				...
				$obj4->addObservationPhotoTailMarkRelatedByToCellId($obj1);
			} // if joined row not null
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptPatternCellTailRelatedByToCellId(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	public static function doSelectJoinAllExceptObservationPhotoTail(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = ObservationPhotoTailMarkPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (ObservationPhotoTailMark) to the collection in $obj3 (PatternCellTail)
				$obj3->addObservationPhotoTailMarkRelatedByToCellId($obj1);
	...
	/**
	 * Selects a collection of ObservationPhotoTailMark objects pre-filled with all related objects except PatternCellTailRelatedByToCellId.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptPatternCellTailRelatedByToCellId(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
