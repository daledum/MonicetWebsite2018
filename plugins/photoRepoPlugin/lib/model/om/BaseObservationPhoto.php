...
abstract class BaseObservationPhoto extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the body_part field.
	 * @var        string
	 */
	protected $body_part;
	...
	/**
	 * The value for the basic_behaviour field.
	 * @var        string
	 */
	protected $basic_behaviour;
	...
	/**
	 * Get the [body_part] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [basic_behaviour] column value.
	 * 
	 * @return     string
	 */
	public function getBasicBehaviour()
	{
		return $this->basic_behaviour;
	}
	...
	/**
	 * Set the value of [body_part] column.
	 * 
	 * @param      string $v new value
	 * @return     ObservationPhoto The current object (for fluent API support)
	 */
	public function setBodyPart($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->body_part !== $v) {
			$this->body_part = $v;
			$this->modifiedColumns[] = ObservationPhotoPeer::BODY_PART;
		}
	...
	/**
	 * Set the value of [basic_behaviour] column.
	 * 
	 * @param      string $v new value
	 * @return     ObservationPhoto The current object (for fluent API support)
	 */
	public function setBasicBehaviour($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->basic_behaviour !== $v) {
			$this->basic_behaviour = $v;
			$this->modifiedColumns[] = ObservationPhotoPeer::BASIC_BEHAVIOUR;
		}
	...
	public function setCopyright($v)
	{
		...
		if ($this->copyright !== $v) {
			$this->copyright = $v;
			$this->modifiedColumns[] = ObservationPhotoPeer::COPYRIGHT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->body_part = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->gender = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->age_group = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->basic_behaviour = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->latitude = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->longitude = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->company_id = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
			...
			$this->photographer_id = ($row[$startcol + 14] !== null) ? (int) $row[$startcol + 14] : null;
			$this->kind_of_photo = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
			$this->photo_quality = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
			...
			return $startcol + 20; // 20 = ObservationPhotoPeer::NUM_COLUMNS - ObservationPhotoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		$result = array(
			...
			$keys[5] => $this->getBodyPart(),
			$keys[6] => $this->getGender(),
			$keys[7] => $this->getAgeGroup(),
			$keys[8] => $this->getBasicBehaviour(),
			...
			$keys[14] => $this->getPhotographerId(),
			$keys[15] => $this->getKindOfPhoto(),
			$keys[16] => $this->getPhotoQuality(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setBodyPart($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setGender($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setAgeGroup($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setBasicBehaviour($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setLatitude($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setLongitude($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setCompanyId($arr[$keys[11]]);
		...
		if (array_key_exists($keys[14], $arr)) $this->setPhotographerId($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setKindOfPhoto($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setPhotoQuality($arr[$keys[16]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ObservationPhotoPeer::BODY_PART)) $criteria->add(ObservationPhotoPeer::BODY_PART, $this->body_part);
		...
		if ($this->isColumnModified(ObservationPhotoPeer::BASIC_BEHAVIOUR)) $criteria->add(ObservationPhotoPeer::BASIC_BEHAVIOUR, $this->basic_behaviour);
		...
		if ($this->isColumnModified(ObservationPhotoPeer::COPYRIGHT)) $criteria->add(ObservationPhotoPeer::COPYRIGHT, $this->copyright);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setBodyPart($this->body_part);
		$copyObj->setGender($this->gender);
		$copyObj->setAgeGroup($this->age_group);
		$copyObj->setBasicBehaviour($this->basic_behaviour);
