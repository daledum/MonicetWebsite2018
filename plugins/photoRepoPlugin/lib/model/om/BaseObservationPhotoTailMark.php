...
/**
 * Base class that represents a row from the 'observation_photo_tail_mark' table.
 *
 * 
 *
 * @package    propel.generator.plugins.photoRepoPlugin.lib.model.om
 */
abstract class BaseObservationPhotoTailMark extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'ObservationPhotoTailMarkPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        ObservationPhotoTailMarkPeer
	 */
	...
	/**
	 * The value for the observation_photo_tail_id field.
	 * @var        int
	 */
	protected $observation_photo_tail_id;

	/**
	 * The value for the pattern_cell_tail_id field.
	 * @var        int
	 */
	protected $pattern_cell_tail_id;
	 ...
	 */
	protected $aObservationPhotoTail;

	/**
	 * @var        PatternCellTail
	 */
	protected $aPatternCellTailRelatedByPatternCellTailId;
	...
	/**
	 * Initializes internal state of BaseObservationPhotoTailMark object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [observation_photo_tail_id] column value.
	 * 
	 * @return     int
	 */
	public function getObservationPhotoTailId()
	{
		return $this->observation_photo_tail_id;
	}

	/**
	 * Get the [pattern_cell_tail_id] column value.
	 * 
	 * @return     int
	 */
	public function getPatternCellTailId()
	{
		return $this->pattern_cell_tail_id;
	}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ObservationPhotoTailMarkPeer::ID;
		}
	...
	/**
	 * Set the value of [observation_photo_tail_id] column.
	 * 
	 * @param      int $v new value
	 * @return     ObservationPhotoTailMark The current object (for fluent API support)
	 */
	public function setObservationPhotoTailId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->observation_photo_tail_id !== $v) {
			$this->observation_photo_tail_id = $v;
			$this->modifiedColumns[] = ObservationPhotoTailMarkPeer::OBSERVATION_PHOTO_TAIL_ID;
		}

		if ($this->aObservationPhotoTail !== null && $this->aObservationPhotoTail->getId() !== $v) {
			$this->aObservationPhotoTail = null;
		}

		return $this;
	} // setObservationPhotoTailId()

	/**
	 * Set the value of [pattern_cell_tail_id] column.
	 * 
	 * @param      int $v new value
	 * @return     ObservationPhotoTailMark The current object (for fluent API support)
	 */
	public function setPatternCellTailId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->pattern_cell_tail_id !== $v) {
			$this->pattern_cell_tail_id = $v;
			$this->modifiedColumns[] = ObservationPhotoTailMarkPeer::PATTERN_CELL_TAIL_ID;
		}

		if ($this->aPatternCellTailRelatedByPatternCellTailId !== null && $this->aPatternCellTailRelatedByPatternCellTailId->getId() !== $v) {
			$this->aPatternCellTailRelatedByPatternCellTailId = null;
		}

		return $this;
	} // setPatternCellTailId()
	...
	public function setIsWide($v)
	{
		...
		if ($this->is_wide !== $v || $this->isNew()) {
			$this->is_wide = $v;
			$this->modifiedColumns[] = ObservationPhotoTailMarkPeer::IS_WIDE;
		}
	...
	public function setIsDeep($v)
	{
		...
		if ($this->is_deep !== $v || $this->isNew()) {
			$this->is_deep = $v;
			$this->modifiedColumns[] = ObservationPhotoTailMarkPeer::IS_DEEP;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->observation_photo_tail_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
	...
	public function ensureConsistency()
	{
		...
		if ($this->aObservationPhotoTail !== null && $this->observation_photo_tail_id !== $this->aObservationPhotoTail->getId()) {
			$this->aObservationPhotoTail = null;
		}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ObservationPhotoTailMarkPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseObservationPhotoTailMark:delete:pre') as $callable)
			{
			...
			if ($ret) {
				ObservationPhotoTailMarkQuery::create()
					->filterByPrimaryKey($this->getPrimaryKey())
					->delete($con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseObservationPhotoTailMark:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseObservationPhotoTailMark:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseObservationPhotoTailMark:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				ObservationPhotoTailMarkPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aObservationPhotoTail !== null) {
				if ($this->aObservationPhotoTail->isModified() || $this->aObservationPhotoTail->isNew()) {
					$affectedRows += $this->aObservationPhotoTail->save($con);
				}
				$this->setObservationPhotoTail($this->aObservationPhotoTail);
			}

			if ($this->aPatternCellTailRelatedByPatternCellTailId !== null) {
				if ($this->aPatternCellTailRelatedByPatternCellTailId->isModified() || $this->aPatternCellTailRelatedByPatternCellTailId->isNew()) {
					$affectedRows += $this->aPatternCellTailRelatedByPatternCellTailId->save($con);
				}
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(ObservationPhotoTailMarkPeer::ID) ) {
					...
					$affectedRows += ObservationPhotoTailMarkPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aObservationPhotoTail !== null) {
				if (!$this->aObservationPhotoTail->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aObservationPhotoTail->getValidationFailures());
				}
			}

			if ($this->aPatternCellTailRelatedByPatternCellTailId !== null) {
				if (!$this->aPatternCellTailRelatedByPatternCellTailId->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aPatternCellTailRelatedByPatternCellTailId->getValidationFailures());
				}
			}
			...
			if (($retval = ObservationPhotoTailMarkPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ObservationPhotoTailMarkPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			case 0:
				...
				break;
			case 1:
				return $this->getObservationPhotoTailId();
				break;
			case 2:
				return $this->getPatternCellTailId();
				break;
			case 3:
	...
	{
		$keys = ObservationPhotoTailMarkPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getObservationPhotoTailId(),
		...
		if ($includeForeignObjects) {
			if (null !== $this->aObservationPhotoTail) {
				$result['ObservationPhotoTail'] = $this->aObservationPhotoTail->toArray($keyType, $includeLazyLoadColumns, true);
			}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			case 0:
				...
				break;
			case 1:
				$this->setObservationPhotoTailId($value);
				break;
			case 2:
				$this->setPatternCellTailId($value);
				break;
			case 3:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setObservationPhotoTailId($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ObservationPhotoTailMarkPeer::ID)) $criteria->add(ObservationPhotoTailMarkPeer::ID, $this->id);
		if ($this->isColumnModified(ObservationPhotoTailMarkPeer::OBSERVATION_PHOTO_TAIL_ID)) $criteria->add(ObservationPhotoTailMarkPeer::OBSERVATION_PHOTO_TAIL_ID, $this->observation_photo_tail_id);
	...
	{
		$criteria = new Criteria(ObservationPhotoTailMarkPeer::DATABASE_NAME);
		$criteria->add(ObservationPhotoTailMarkPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ObservationPhotoTailMark (or compatible) type.
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @throws     PropelException
	 */
	public function copyInto($copyObj, $deepCopy = false)
	{
		$copyObj->setObservationPhotoTailId($this->observation_photo_tail_id);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ObservationPhotoTailMark Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ObservationPhotoTailMarkPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ObservationPhotoTailMarkPeer();
		}
		return self::$peer;
	}

	/**
	 * Declares an association between this object and a ObservationPhotoTail object.
	 *
	 * @param      ObservationPhotoTail $v
	 * @return     ObservationPhotoTailMark The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setObservationPhotoTail(ObservationPhotoTail $v = null)
	{
		if ($v === null) {
			$this->setObservationPhotoTailId(NULL);
		} else {
			$this->setObservationPhotoTailId($v->getId());
		}

		$this->aObservationPhotoTail = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the ObservationPhotoTail object, it will not be re-added.
		if ($v !== null) {
			$v->addObservationPhotoTailMark($this);
		}
	...
	/**
	 * Get the associated ObservationPhotoTail object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     ObservationPhotoTail The associated ObservationPhotoTail object.
	 * @throws     PropelException
	 */
	public function getObservationPhotoTail(PropelPDO $con = null)
	{
		if ($this->aObservationPhotoTail === null && ($this->observation_photo_tail_id !== null)) {
			$this->aObservationPhotoTail = ObservationPhotoTailQuery::create()->findPk($this->observation_photo_tail_id, $con);
			/* The following can be used additionally to
				 guarantee the related object contains a reference
				 to this object.  This level of coupling may, however, be
				 undesirable since it could result in an only partially populated collection
				 in the referenced object.
				 $this->aObservationPhotoTail->addObservationPhotoTailMarks($this);
			 */
		}
		return $this->aObservationPhotoTail;
	}
	 ...
	 * @throws     PropelException
	 */
	public function setPatternCellTailRelatedByPatternCellTailId(PatternCellTail $v = null)
	{
		if ($v === null) {
			$this->setPatternCellTailId(NULL);
		} else {
			$this->setPatternCellTailId($v->getId());
		}

		$this->aPatternCellTailRelatedByPatternCellTailId = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the PatternCellTail object, it will not be re-added.
		if ($v !== null) {
			$v->addObservationPhotoTailMarkRelatedByPatternCellTailId($this);
		}
	 ...
	 * @throws     PropelException
	 */
	public function getPatternCellTailRelatedByPatternCellTailId(PropelPDO $con = null)
	{
		if ($this->aPatternCellTailRelatedByPatternCellTailId === null && ($this->pattern_cell_tail_id !== null)) {
			$this->aPatternCellTailRelatedByPatternCellTailId = PatternCellTailQuery::create()->findPk($this->pattern_cell_tail_id, $con);
			/* The following can be used additionally to
				 guarantee the related object contains a reference
				 to this object.  This level of coupling may, however, be
				 undesirable since it could result in an only partially populated collection
				 in the referenced object.
				 $this->aPatternCellTailRelatedByPatternCellTailId->addObservationPhotoTailMarksRelatedByPatternCellTailId($this);
			 */
		}
		return $this->aPatternCellTailRelatedByPatternCellTailId;
	}
	...
	{
		$this->id = null;
		$this->observation_photo_tail_id = null;
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseObservationPhotoTailMark:' . $name))
		{
