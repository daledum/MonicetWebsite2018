...
abstract class BaseObservationPhotoDorsalRightMarkPeer {
	...
	const TO_CELL_ID = 'observation_photo_dorsal_right_mark.TO_CELL_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ObservationPhotoDorsalRightId', 'PatternCellDorsalRightId', 'IsWide', 'IsDeep', 'ToCellId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'observationPhotoDorsalRightId', 'patternCellDorsalRightId', 'isWide', 'isDeep', 'toCellId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::OBSERVATION_PHOTO_DORSAL_RIGHT_ID, self::PATTERN_CELL_DORSAL_RIGHT_ID, self::IS_WIDE, self::IS_DEEP, self::TO_CELL_ID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'OBSERVATION_PHOTO_DORSAL_RIGHT_ID', 'PATTERN_CELL_DORSAL_RIGHT_ID', 'IS_WIDE', 'IS_DEEP', 'TO_CELL_ID', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'observation_photo_dorsal_right_id', 'pattern_cell_dorsal_right_id', 'is_wide', 'is_deep', 'to_cell_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ObservationPhotoDorsalRightId' => 1, 'PatternCellDorsalRightId' => 2, 'IsWide' => 3, 'IsDeep' => 4, 'ToCellId' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'observationPhotoDorsalRightId' => 1, 'patternCellDorsalRightId' => 2, 'isWide' => 3, 'isDeep' => 4, 'toCellId' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::OBSERVATION_PHOTO_DORSAL_RIGHT_ID => 1, self::PATTERN_CELL_DORSAL_RIGHT_ID => 2, self::IS_WIDE => 3, self::IS_DEEP => 4, self::TO_CELL_ID => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'OBSERVATION_PHOTO_DORSAL_RIGHT_ID' => 1, 'PATTERN_CELL_DORSAL_RIGHT_ID' => 2, 'IS_WIDE' => 3, 'IS_DEEP' => 4, 'TO_CELL_ID' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'observation_photo_dorsal_right_id' => 1, 'pattern_cell_dorsal_right_id' => 2, 'is_wide' => 3, 'is_deep' => 4, 'to_cell_id' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(ObservationPhotoDorsalRightMarkPeer::TO_CELL_ID);
		} else {
	...
	/**
	 * Returns the number of rows matching criteria, joining the related PatternCellDorsalRightRelatedByToCellId table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinPatternCellDorsalRightRelatedByToCellId(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(ObservationPhotoDorsalRightMarkPeer::TO_CELL_ID, PatternCellDorsalRightPeer::ID, $join_behavior);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinPatternCellDorsalRightRelatedByToCellId(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (ObservationPhotoDorsalRightMark) to $obj2 (PatternCellDorsalRight)
				$obj2->addObservationPhotoDorsalRightMarkRelatedByToCellId($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key4 !== null) {
				...
				$obj4->addObservationPhotoDorsalRightMarkRelatedByToCellId($obj1);
			} // if joined row not null
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptPatternCellDorsalRightRelatedByToCellId(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	public static function doSelectJoinAllExceptObservationPhotoDorsalRight(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = ObservationPhotoDorsalRightMarkPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (ObservationPhotoDorsalRightMark) to the collection in $obj3 (PatternCellDorsalRight)
				$obj3->addObservationPhotoDorsalRightMarkRelatedByToCellId($obj1);
	...
	/**
	 * Selects a collection of ObservationPhotoDorsalRightMark objects pre-filled with all related objects except PatternCellDorsalRightRelatedByToCellId.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptPatternCellDorsalRightRelatedByToCellId(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
