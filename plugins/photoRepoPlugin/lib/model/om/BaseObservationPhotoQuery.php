 ...
 * @method     ObservationPhotoQuery orderByBodyPart($order = Criteria::ASC) Order by the body_part column
 ...
 * @method     ObservationPhotoQuery orderByBasicBehaviour($order = Criteria::ASC) Order by the basic_behaviour column
 ...
 * @method     ObservationPhotoQuery orderByCopyright($order = Criteria::ASC) Order by the copyright column
 ...
 * @method     ObservationPhotoQuery groupByBodyPart() Group by the body_part column
 ...
 * @method     ObservationPhotoQuery groupByBasicBehaviour() Group by the basic_behaviour column
 ...
 * @method     ObservationPhotoQuery groupByCopyright() Group by the copyright column
 ...
 * @method     ObservationPhoto findOneByBodyPart(string $body_part) Return the first ObservationPhoto filtered by the body_part column
 ...
 * @method     ObservationPhoto findOneByBasicBehaviour(string $basic_behaviour) Return the first ObservationPhoto filtered by the basic_behaviour column
 ...
 * @method     ObservationPhoto findOneByCopyright(string $copyright) Return the first ObservationPhoto filtered by the copyright column
 ...
 * @method     array findByBodyPart(string $body_part) Return ObservationPhoto objects filtered by the body_part column
 ...
 * @method     array findByBasicBehaviour(string $basic_behaviour) Return ObservationPhoto objects filtered by the basic_behaviour column
 ...
 * @method     array findByCopyright(string $copyright) Return ObservationPhoto objects filtered by the copyright column
...
abstract class BaseObservationPhotoQuery extends ModelCriteria
{
	...
	/**
	 * Filter the query on the body_part column
	 * 
	 * @param     string $bodyPart The value to use as filter.
	 *            Accepts wildcards (* and % trigger a LIKE)
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    ObservationPhotoQuery The current query, for fluid interface
	 */
	public function filterByBodyPart($bodyPart = null, $comparison = null)
	{
		if (null === $comparison) {
			if (is_array($bodyPart)) {
				$comparison = Criteria::IN;
			} elseif (preg_match('/[\%\*]/', $bodyPart)) {
				$bodyPart = str_replace('*', '%', $bodyPart);
				$comparison = Criteria::LIKE;
			}
		}
		return $this->addUsingAlias(ObservationPhotoPeer::BODY_PART, $bodyPart, $comparison);
	}
	...
	/**
	 * Filter the query on the basic_behaviour column
	 * 
	 * @param     string $basicBehaviour The value to use as filter.
	 *            Accepts wildcards (* and % trigger a LIKE)
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    ObservationPhotoQuery The current query, for fluid interface
	 */
	public function filterByBasicBehaviour($basicBehaviour = null, $comparison = null)
	{
		if (null === $comparison) {
			if (is_array($basicBehaviour)) {
				$comparison = Criteria::IN;
			} elseif (preg_match('/[\%\*]/', $basicBehaviour)) {
				$basicBehaviour = str_replace('*', '%', $basicBehaviour);
				$comparison = Criteria::LIKE;
			}
		}
		return $this->addUsingAlias(ObservationPhotoPeer::BASIC_BEHAVIOUR, $basicBehaviour, $comparison);
	}
	...
	public function filterByCopyright($copyright = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(ObservationPhotoPeer::COPYRIGHT, $copyright, $comparison);
	}
