 ...
 * @method     PhotographerQuery orderByCpoyright($order = Criteria::ASC) Order by the cpoyright column
 ...
 * @method     PhotographerQuery groupByCpoyright() Group by the cpoyright column
 ...
 * @method     Photographer findOneByCpoyright(string $cpoyright) Return the first Photographer filtered by the cpoyright column
 ...
 * @method     array findByCpoyright(string $cpoyright) Return Photographer objects filtered by the cpoyright column
...
abstract class BasePhotographerQuery extends ModelCriteria
{
	...
	/**
	 * Filter the query on the cpoyright column
	 * 
	 * @param     string $cpoyright The value to use as filter.
	 *            Accepts wildcards (* and % trigger a LIKE)
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    PhotographerQuery The current query, for fluid interface
	 */
	public function filterByCpoyright($cpoyright = null, $comparison = null)
	{
		if (null === $comparison) {
			if (is_array($cpoyright)) {
				$comparison = Criteria::IN;
			} elseif (preg_match('/[\%\*]/', $cpoyright)) {
				$cpoyright = str_replace('*', '%', $cpoyright);
				$comparison = Criteria::LIKE;
			}
		}
		return $this->addUsingAlias(PhotographerPeer::CPOYRIGHT, $cpoyright, $comparison);
	}
