...
abstract class BasePattern extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the columns_dorsal_lef field.
	 * Note: this column has a database default value of: 1
	 * @var        int
	 */
	protected $columns_dorsal_lef;
	...
	/**
	 * Get the [columns_dorsal_lef] column value.
	 * 
	 * @return     int
	 */
	public function getColumnsDorsalLef()
	{
		return $this->columns_dorsal_lef;
	}
	...
	/**
	 * Set the value of [columns_dorsal_lef] column.
	 * 
	 * @param      int $v new value
	 * @return     Pattern The current object (for fluent API support)
	 */
	public function setColumnsDorsalLef($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->columns_dorsal_lef !== $v || $this->isNew()) {
			$this->columns_dorsal_lef = $v;
			$this->modifiedColumns[] = PatternPeer::COLUMNS_DORSAL_LEF;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->columns_dorsal_lef = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 6:
				...
				break;
			case 7:
				return $this->getColumnsDorsalLef();
				break;
			case 8:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		$result = array(
			...
			$keys[7] => $this->getColumnsDorsalLef(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 6:
				...
				break;
			case 7:
				$this->setColumnsDorsalLef($value);
				break;
			case 8:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[7], $arr)) $this->setColumnsDorsalLef($arr[$keys[7]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PatternPeer::COLUMNS_DORSAL_LEF)) $criteria->add(PatternPeer::COLUMNS_DORSAL_LEF, $this->columns_dorsal_lef);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setColumnsDorsalLef($this->columns_dorsal_lef);
