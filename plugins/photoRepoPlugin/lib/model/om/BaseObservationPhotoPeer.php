...
abstract class BaseObservationPhotoPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Code', 'FileName', 'PhotoDate', 'PhotoTime', 'IndividualId', 'SpecieId', 'Island', 'BodyPartId', 'Gender', 'AgeGroup', 'BehaviourId', 'Latitude', 'Longitude', 'CompanyId', 'VesselId', 'PhotographerId', 'KindOfPhoto', 'PhotoQuality', 'IsBest', 'Notes', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'code', 'fileName', 'photoDate', 'photoTime', 'individualId', 'specieId', 'island', 'bodyPartId', 'gender', 'ageGroup', 'behaviourId', 'latitude', 'longitude', 'companyId', 'vesselId', 'photographerId', 'kindOfPhoto', 'photoQuality', 'isBest', 'notes', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CODE, self::FILE_NAME, self::PHOTO_DATE, self::PHOTO_TIME, self::INDIVIDUAL_ID, self::SPECIE_ID, self::ISLAND, self::BODY_PART_ID, self::GENDER, self::AGE_GROUP, self::BEHAVIOUR_ID, self::LATITUDE, self::LONGITUDE, self::COMPANY_ID, self::VESSEL_ID, self::PHOTOGRAPHER_ID, self::KIND_OF_PHOTO, self::PHOTO_QUALITY, self::IS_BEST, self::NOTES, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CODE', 'FILE_NAME', 'PHOTO_DATE', 'PHOTO_TIME', 'INDIVIDUAL_ID', 'SPECIE_ID', 'ISLAND', 'BODY_PART_ID', 'GENDER', 'AGE_GROUP', 'BEHAVIOUR_ID', 'LATITUDE', 'LONGITUDE', 'COMPANY_ID', 'VESSEL_ID', 'PHOTOGRAPHER_ID', 'KIND_OF_PHOTO', 'PHOTO_QUALITY', 'IS_BEST', 'NOTES', 'CREATED_AT', 'UPDATED_AT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'code', 'file_name', 'photo_date', 'photo_time', 'individual_id', 'specie_id', 'island', 'body_part_id', 'gender', 'age_group', 'behaviour_id', 'latitude', 'longitude', 'company_id', 'vessel_id', 'photographer_id', 'kind_of_photo', 'photo_quality', 'is_best', 'notes', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Code' => 1, 'FileName' => 2, 'PhotoDate' => 3, 'PhotoTime' => 4, 'IndividualId' => 5, 'SpecieId' => 6, 'Island' => 7, 'BodyPartId' => 8, 'Gender' => 9, 'AgeGroup' => 10, 'BehaviourId' => 11, 'Latitude' => 12, 'Longitude' => 13, 'CompanyId' => 14, 'VesselId' => 15, 'PhotographerId' => 16, 'KindOfPhoto' => 17, 'PhotoQuality' => 18, 'IsBest' => 19, 'Notes' => 20, 'CreatedAt' => 21, 'UpdatedAt' => 22, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'code' => 1, 'fileName' => 2, 'photoDate' => 3, 'photoTime' => 4, 'individualId' => 5, 'specieId' => 6, 'island' => 7, 'bodyPartId' => 8, 'gender' => 9, 'ageGroup' => 10, 'behaviourId' => 11, 'latitude' => 12, 'longitude' => 13, 'companyId' => 14, 'vesselId' => 15, 'photographerId' => 16, 'kindOfPhoto' => 17, 'photoQuality' => 18, 'isBest' => 19, 'notes' => 20, 'createdAt' => 21, 'updatedAt' => 22, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CODE => 1, self::FILE_NAME => 2, self::PHOTO_DATE => 3, self::PHOTO_TIME => 4, self::INDIVIDUAL_ID => 5, self::SPECIE_ID => 6, self::ISLAND => 7, self::BODY_PART_ID => 8, self::GENDER => 9, self::AGE_GROUP => 10, self::BEHAVIOUR_ID => 11, self::LATITUDE => 12, self::LONGITUDE => 13, self::COMPANY_ID => 14, self::VESSEL_ID => 15, self::PHOTOGRAPHER_ID => 16, self::KIND_OF_PHOTO => 17, self::PHOTO_QUALITY => 18, self::IS_BEST => 19, self::NOTES => 20, self::CREATED_AT => 21, self::UPDATED_AT => 22, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CODE' => 1, 'FILE_NAME' => 2, 'PHOTO_DATE' => 3, 'PHOTO_TIME' => 4, 'INDIVIDUAL_ID' => 5, 'SPECIE_ID' => 6, 'ISLAND' => 7, 'BODY_PART_ID' => 8, 'GENDER' => 9, 'AGE_GROUP' => 10, 'BEHAVIOUR_ID' => 11, 'LATITUDE' => 12, 'LONGITUDE' => 13, 'COMPANY_ID' => 14, 'VESSEL_ID' => 15, 'PHOTOGRAPHER_ID' => 16, 'KIND_OF_PHOTO' => 17, 'PHOTO_QUALITY' => 18, 'IS_BEST' => 19, 'NOTES' => 20, 'CREATED_AT' => 21, 'UPDATED_AT' => 22, ),
