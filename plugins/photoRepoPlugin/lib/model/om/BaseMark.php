...
abstract class BaseMark extends BaseObject  implements Persistent
{
	...
	public function setImage($v)
	{
		...
		if ($this->image !== $v) {
			$this->image = $v;
			$this->modifiedColumns[] = MarkPeer::IMAGE;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = MarkPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = MarkPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = MarkPeer::NUM_COLUMNS - MarkPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($this->isModified() && !$this->isColumnModified(MarkPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(MarkPeer::CREATED_AT))
				{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(MarkPeer::ID) ) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MarkPeer::IMAGE)) $criteria->add(MarkPeer::IMAGE, $this->image);
		if ($this->isColumnModified(MarkPeer::CREATED_AT)) $criteria->add(MarkPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(MarkPeer::UPDATED_AT)) $criteria->add(MarkPeer::UPDATED_AT, $this->updated_at);
	 ...
	 * If this Mark is new, it will return
	 ...
	 * @return     PropelCollection|array ObservationPhotoTailMark[] List of ObservationPhotoTailMark objects
	 */
	public function getObservationPhotoTailMarksJoinObservationPhotoTail($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ObservationPhotoTailMarkQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array ObservationPhotoDorsalLeftMark[] List of ObservationPhotoDorsalLeftMark objects
	 */
	public function getObservationPhotoDorsalLeftMarksJoinObservationPhotoDorsalLeft($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ObservationPhotoDorsalLeftMarkQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array ObservationPhotoDorsalRightMark[] List of ObservationPhotoDorsalRightMark objects
	 */
	public function getObservationPhotoDorsalRightMarksJoinObservationPhotoDorsalRight($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ObservationPhotoDorsalRightMarkQuery::create(null, $criteria);
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseMark:' . $name))
		{
