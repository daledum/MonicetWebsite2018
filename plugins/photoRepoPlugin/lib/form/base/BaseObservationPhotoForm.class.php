...
abstract class BaseObservationPhotoForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'body_part'       => new sfWidgetFormInputText(),
      'gender'          => new sfWidgetFormInputText(),
      'age_group'       => new sfWidgetFormInputText(),
      'basic_behaviour' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'body_part'       => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      ...
      'basic_behaviour' => new sfValidatorString(array('max_length' => 255, 'required' => false)),
