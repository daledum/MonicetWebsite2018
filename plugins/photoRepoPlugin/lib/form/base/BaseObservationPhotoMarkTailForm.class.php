...
/**
 * ObservationPhotoMarkTail form base class.
 *
 * @method ObservationPhotoMarkTail getObject() Returns the current form's model object
 *
 * @package    ##PROJECT_NAME##
 * @subpackage form
 * @author     ##AUTHOR_NAME##
 */
abstract class BaseObservationPhotoMarkTailForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'          => new sfValidatorPropelChoice(array('model' => 'ObservationPhotoMarkTail', 'column' => 'id', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('observation_photo_mark_tail[%s]');
