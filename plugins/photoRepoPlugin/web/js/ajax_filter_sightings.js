$(document).ready(function() {
    ...
    $.ajax({
        url: window.location.protocol + '//' + window.location.host+'/admin.php/ajax/filter-sightings?ob_date=' + photoDate + '&specie_id=' + $('#observation_photo_specie_id').val() + '&company_id=' + $('#observation_photo_company_id').val() + '&vessel_id='+ $('#observation_photo_vessel_id').val(),
        type: 'POST',
