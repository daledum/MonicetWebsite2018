...
abstract class BasePublicationPeer {
	...
	const CLASS_DEFAULT = 'plugins.publicationPlugin.lib.model.Publication';
	...
	const IS_ACTIVE = 'publication.IS_ACTIVE';

	/** the column name for the ORDER field */
	const ORDER = 'publication.ORDER';

	/** the column name for the FILE_ADDRESS field */
	const FILE_ADDRESS = 'publication.FILE_ADDRESS';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'IsActive', 'Order', 'FileAddress', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'isActive', 'order', 'fileAddress', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::IS_ACTIVE, self::ORDER, self::FILE_ADDRESS, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'IS_ACTIVE', 'ORDER', 'FILE_ADDRESS', 'CREATED_AT', 'UPDATED_AT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'is_active', 'order', 'file_address', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'IsActive' => 1, 'Order' => 2, 'FileAddress' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'isActive' => 1, 'order' => 2, 'fileAddress' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::IS_ACTIVE => 1, self::ORDER => 2, self::FILE_ADDRESS => 3, self::CREATED_AT => 4, self::UPDATED_AT => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'IS_ACTIVE' => 1, 'ORDER' => 2, 'FILE_ADDRESS' => 3, 'CREATED_AT' => 4, 'UPDATED_AT' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'is_active' => 1, 'order' => 2, 'file_address' => 3, 'created_at' => 4, 'updated_at' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(PublicationPeer::IS_ACTIVE);
			$criteria->addSelectColumn(PublicationPeer::ORDER);
			$criteria->addSelectColumn(PublicationPeer::FILE_ADDRESS);
			...
			$criteria->addSelectColumn($alias . '.FILE_ADDRESS');
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = PublicationPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + PublicationPeer::NUM_COLUMNS;
		} else {
	...
	/**
	 * Selects a collection of {@link Publication} objects with a {@link PublicationI18n} translation populated.
	 *
	 * @param Criteria  $criteria
	...
	static public function doSelectWithI18n(Criteria $criteria, $culture = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
	  ...
	  $criteria->addJoin(PublicationPeer::ID, PublicationI18nPeer::ID, $join_behavior);
	  $criteria->add(PublicationI18nPeer::CULTURE, $culture);
	
	  foreach (sfMixer::getCallables('BasePublication:doSelectJoin:doSelectJoin') as $sf_hook)
	  {
	    call_user_func($sf_hook, 'Publication', $criteria, $con);
	  }
	  ...
	  $stmt = BasePeer::doSelect($criteria, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
	      ...
	      PublicationPeer::addInstanceToPool($obj1, $key1);
			...
			$key2 = PublicationI18nPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = PublicationI18nPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					$cls = PublicationI18nPeer::getOMClass(false);
					$obj2 = new $cls();
					$obj2->hydrate($row, $startcol);
					PublicationI18nPeer::addInstanceToPool($obj2, $key2);
