...
class PublicationTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'plugins.publicationPlugin.lib.model.map.PublicationTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('FILE_ADDRESS', 'FileAddress', 'VARCHAR', true, 255, null);
	...
	{
    $this->addRelation('PublicationI18n', 'PublicationI18n', RelationMap::ONE_TO_MANY, array('id' => 'id', ), null, null);
	} // buildRelations()
	...
	public function getBehaviors()
	{
		return array(
			...
			'symfony_i18n' => array('i18n_table' => 'publication_i18n', ),
		);
	} // getBehaviors()
