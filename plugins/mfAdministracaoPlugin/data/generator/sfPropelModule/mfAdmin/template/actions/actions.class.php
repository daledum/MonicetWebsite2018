...
abstract class <?php echo $this->getGeneratedModuleName() ?>Actions extends <?php echo $this->getActionsBaseClass()."\n" ?>
{
  public function preExecute()
  {
    ...
    // verify if credentials were defined in the configuration file, if not, enough credentials
    if ( (is_array($credentials) && count($credentials) > 0) && !$this->getUser()->hasCredential($credentials))
    {
