...
class sfGuardUserTableMap extends TableMap {
    ...
    $this->addRelation('WatchInfoRelatedByCreatedBy', 'WatchInfo', RelationMap::ONE_TO_MANY, array('id' => 'created_by', ), 'CASCADE', null);
    $this->addRelation('WatchInfoRelatedByUpdatedBy', 'WatchInfo', RelationMap::ONE_TO_MANY, array('id' => 'updated_by', ), 'CASCADE', null);
    $this->addRelation('prUser', 'prUser', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'SET NULL', null);
    $this->addRelation('ObservationPhotoRelatedByLastEditedBy', 'ObservationPhoto', RelationMap::ONE_TO_MANY, array('id' => 'last_edited_by', ), 'SET NULL', null);
    $this->addRelation('ObservationPhotoRelatedByValidatedBy', 'ObservationPhoto', RelationMap::ONE_TO_MANY, array('id' => 'validated_by', ), 'SET NULL', null);
