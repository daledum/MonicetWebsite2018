...
class sfGuardUserTableMap extends TableMap {
    ...
    $this->addRelation('GeneralInfoRelatedBySkipperId', 'GeneralInfo', RelationMap::ONE_TO_MANY, array('id' => 'skipper_id', ), 'CASCADE', null);
    $this->addRelation('GeneralInfoRelatedByGuideId', 'GeneralInfo', RelationMap::ONE_TO_MANY, array('id' => 'guide_id', ), 'CASCADE', null);
