...
abstract class BasesfGuardUserPeer {
	...
	public static function clearRelatedInstancePool()
	{
		...
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
		WatchInfoPeer::clearInstancePool();
		// Invalidate objects in prUserPeer instance pool, 
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(CompanyUserPeer::USER_ID, $obj->getId());
			...
			$criteria->add(GeneralInfoPeer::CREATED_BY, $obj->getId());
			$affectedRows += GeneralInfoPeer::doDelete($criteria, $con);

			// delete related GeneralInfo objects
			$criteria = new Criteria(GeneralInfoPeer::DATABASE_NAME);
			
			$criteria->add(GeneralInfoPeer::UPDATED_BY, $obj->getId());
			$affectedRows += GeneralInfoPeer::doDelete($criteria, $con);

			// delete related User objects
			$criteria = new Criteria(UserPeer::DATABASE_NAME);
			
			$criteria->add(UserPeer::USER_ID, $obj->getId());
			...
			$criteria->add(WatchInfoPeer::CREATED_BY, $obj->getId());
			$affectedRows += WatchInfoPeer::doDelete($criteria, $con);

			// delete related WatchInfo objects
			$criteria = new Criteria(WatchInfoPeer::DATABASE_NAME);
			
			$criteria->add(WatchInfoPeer::UPDATED_BY, $obj->getId());
			$affectedRows += WatchInfoPeer::doDelete($criteria, $con);
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// set fkey col in related prUser rows to NULL
			$selectCriteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
			$updateValues = new Criteria(sfGuardUserPeer::DATABASE_NAME);
			$selectCriteria->add(prUserPeer::USER_ID, $obj->getId());
			$updateValues->add(prUserPeer::USER_ID, null);
			...
			$selectCriteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
			$updateValues = new Criteria(sfGuardUserPeer::DATABASE_NAME);
			$selectCriteria->add(ObservationPhotoPeer::LAST_EDITED_BY, $obj->getId());
			$updateValues->add(ObservationPhotoPeer::LAST_EDITED_BY, null);
			...
			$selectCriteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
			$updateValues = new Criteria(sfGuardUserPeer::DATABASE_NAME);
			$selectCriteria->add(ObservationPhotoPeer::VALIDATED_BY, $obj->getId());
			$updateValues->add(ObservationPhotoPeer::VALIDATED_BY, null);
