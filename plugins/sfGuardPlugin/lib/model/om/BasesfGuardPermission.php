...
abstract class BasesfGuardPermission extends BaseObject  implements Persistent
{
  ...
  const PEER = 'sfGuardPermissionPeer';
	...
	{
		$query = sfGuardGroupPermissionQuery::create(null, $criteria);
		$query->joinWith('sfGuardGroupPermission.sfGuardGroup', $join_behavior);
	...
	{
		$query = sfGuardUserPermissionQuery::create(null, $criteria);
		$query->joinWith('sfGuardUserPermission.sfGuardUser', $join_behavior);
	 ...
	 * actually need in sfGuardPermission.
	 */
	public function getmfMenusJoinmfMenuRelatedById($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = mfMenuQuery::create(null, $criteria);
		$query->joinWith('mfMenu.mfMenuRelatedById', $join_behavior);
