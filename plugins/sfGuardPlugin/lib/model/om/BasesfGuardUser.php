...
abstract class BasesfGuardUser extends BaseObject  implements Persistent
{
	 ...
	 */
	protected $collGeneralInfosRelatedByCreatedBy;

	/**
	 * @var        array GeneralInfo[] Collection to store aggregation of GeneralInfo objects.
	 */
	protected $collGeneralInfosRelatedByUpdatedBy;
	 ...
	 */
	protected $collWatchInfosRelatedByCreatedBy;

	/**
	 * @var        array WatchInfo[] Collection to store aggregation of WatchInfo objects.
	 */
	protected $collWatchInfosRelatedByUpdatedBy;

	/**
	 * @var        array prUser[] Collection to store aggregation of prUser objects.
	 */
	protected $collprUsers;

	/**
	 * @var        array ObservationPhoto[] Collection to store aggregation of ObservationPhoto objects.
	 */
	protected $collObservationPhotosRelatedByLastEditedBy;

	/**
	 * @var        array ObservationPhoto[] Collection to store aggregation of ObservationPhoto objects.
	 */
	protected $collObservationPhotosRelatedByValidatedBy;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collGeneralInfosRelatedByCreatedBy = null;

			$this->collGeneralInfosRelatedByUpdatedBy = null;

			$this->collUsers = null;

			$this->collWatchInfosRelatedByCreatedBy = null;

			$this->collWatchInfosRelatedByUpdatedBy = null;

			$this->collprUsers = null;

			$this->collObservationPhotosRelatedByLastEditedBy = null;

			$this->collObservationPhotosRelatedByValidatedBy = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collGeneralInfosRelatedByCreatedBy !== null) {
				foreach ($this->collGeneralInfosRelatedByCreatedBy as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collGeneralInfosRelatedByUpdatedBy !== null) {
				foreach ($this->collGeneralInfosRelatedByUpdatedBy as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collWatchInfosRelatedByCreatedBy !== null) {
				foreach ($this->collWatchInfosRelatedByCreatedBy as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collWatchInfosRelatedByUpdatedBy !== null) {
				foreach ($this->collWatchInfosRelatedByUpdatedBy as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collprUsers !== null) {
				foreach ($this->collprUsers as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collObservationPhotosRelatedByLastEditedBy !== null) {
				foreach ($this->collObservationPhotosRelatedByLastEditedBy as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collObservationPhotosRelatedByValidatedBy !== null) {
				foreach ($this->collObservationPhotosRelatedByValidatedBy as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getGeneralInfosRelatedByCreatedBy() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addGeneralInfoRelatedByCreatedBy($relObj->copy($deepCopy));
				}
			}

			foreach ($this->getGeneralInfosRelatedByUpdatedBy() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addGeneralInfoRelatedByUpdatedBy($relObj->copy($deepCopy));
				}
			}
			...
			foreach ($this->getWatchInfosRelatedByCreatedBy() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addWatchInfoRelatedByCreatedBy($relObj->copy($deepCopy));
				}
			}

			foreach ($this->getWatchInfosRelatedByUpdatedBy() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addWatchInfoRelatedByUpdatedBy($relObj->copy($deepCopy));
				}
			}

			foreach ($this->getprUsers() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addprUser($relObj->copy($deepCopy));
				}
			}

			foreach ($this->getObservationPhotosRelatedByLastEditedBy() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addObservationPhotoRelatedByLastEditedBy($relObj->copy($deepCopy));
				}
			}

			foreach ($this->getObservationPhotosRelatedByValidatedBy() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addObservationPhotoRelatedByValidatedBy($relObj->copy($deepCopy));
				}
			}
	 ...
	 * @return     PropelCollection|array mfFormularioUtilizador[] List of mfFormularioUtilizador objects
	 */
	public function getmfFormularioUtilizadorsJoinmfFormulario($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = mfFormularioUtilizadorQuery::create(null, $criteria);
		$query->joinWith('mfFormulario', $join_behavior);
	...
	/**
	 * Clears out the collGeneralInfosRelatedByCreatedBy collection
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addGeneralInfosRelatedByCreatedBy()
	 */
	public function clearGeneralInfosRelatedByCreatedBy()
	{
		$this->collGeneralInfosRelatedByCreatedBy = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collGeneralInfosRelatedByCreatedBy collection.
	 *
	 * By default this just sets the collGeneralInfosRelatedByCreatedBy collection to an empty array (like clearcollGeneralInfosRelatedByCreatedBy());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initGeneralInfosRelatedByCreatedBy()
	{
		$this->collGeneralInfosRelatedByCreatedBy = new PropelObjectCollection();
		$this->collGeneralInfosRelatedByCreatedBy->setModel('GeneralInfo');
	}
	 ...
	 * @throws     PropelException
	 */
	public function getGeneralInfosRelatedByCreatedBy($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collGeneralInfosRelatedByCreatedBy || null !== $criteria) {
			if ($this->isNew() && null === $this->collGeneralInfosRelatedByCreatedBy) {
				// return empty collection
				$this->initGeneralInfosRelatedByCreatedBy();
			} else {
				$collGeneralInfosRelatedByCreatedBy = GeneralInfoQuery::create(null, $criteria)
					->filterBysfGuardUserRelatedByCreatedBy($this)
					->find($con);
				if (null !== $criteria) {
					return $collGeneralInfosRelatedByCreatedBy;
				}
				$this->collGeneralInfosRelatedByCreatedBy = $collGeneralInfosRelatedByCreatedBy;
			}
		}
		return $this->collGeneralInfosRelatedByCreatedBy;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countGeneralInfosRelatedByCreatedBy(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collGeneralInfosRelatedByCreatedBy || null !== $criteria) {
			if ($this->isNew() && null === $this->collGeneralInfosRelatedByCreatedBy) {
				return 0;
			...
			return count($this->collGeneralInfosRelatedByCreatedBy);
		}
	}
	 ...
	 * @throws     PropelException
	 */
	public function addGeneralInfoRelatedByCreatedBy(GeneralInfo $l)
	{
		if ($this->collGeneralInfosRelatedByCreatedBy === null) {
			$this->initGeneralInfosRelatedByCreatedBy();
		}
		if (!$this->collGeneralInfosRelatedByCreatedBy->contains($l)) { // only add it if the **same** object is not already associated
			$this->collGeneralInfosRelatedByCreatedBy[]= $l;
	 ...
	 * Otherwise if this sfGuardUser is new, it will return
	 * an empty collection; or if this sfGuardUser has previously
	 * been saved, it will retrieve related GeneralInfosRelatedByCreatedBy from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in sfGuardUser.
	 ...
	 * @return     PropelCollection|array GeneralInfo[] List of GeneralInfo objects
	 */
	public function getGeneralInfosRelatedByCreatedByJoinVessel($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('Vessel', $join_behavior);

		return $this->getGeneralInfosRelatedByCreatedBy($query, $con);
	}
	 ...
	 * @return     PropelCollection|array GeneralInfo[] List of GeneralInfo objects
	 */
	public function getGeneralInfosRelatedByCreatedByJoinSkipper($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = GeneralInfoQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array GeneralInfo[] List of GeneralInfo objects
	 */
	public function getGeneralInfosRelatedByCreatedByJoinGuide($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = GeneralInfoQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array GeneralInfo[] List of GeneralInfo objects
	 */
	public function getGeneralInfosRelatedByCreatedByJoinCompany($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('Company', $join_behavior);
	...
	/**
	 * Clears out the collGeneralInfosRelatedByUpdatedBy collection
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addGeneralInfosRelatedByUpdatedBy()
	 */
	public function clearGeneralInfosRelatedByUpdatedBy()
	{
		$this->collGeneralInfosRelatedByUpdatedBy = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collGeneralInfosRelatedByUpdatedBy collection.
	 *
	 * By default this just sets the collGeneralInfosRelatedByUpdatedBy collection to an empty array (like clearcollGeneralInfosRelatedByUpdatedBy());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initGeneralInfosRelatedByUpdatedBy()
	{
		$this->collGeneralInfosRelatedByUpdatedBy = new PropelObjectCollection();
		$this->collGeneralInfosRelatedByUpdatedBy->setModel('GeneralInfo');
	}
	 ...
	 * @throws     PropelException
	 */
	public function getGeneralInfosRelatedByUpdatedBy($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collGeneralInfosRelatedByUpdatedBy || null !== $criteria) {
			if ($this->isNew() && null === $this->collGeneralInfosRelatedByUpdatedBy) {
				// return empty collection
				$this->initGeneralInfosRelatedByUpdatedBy();
			} else {
				$collGeneralInfosRelatedByUpdatedBy = GeneralInfoQuery::create(null, $criteria)
					->filterBysfGuardUserRelatedByUpdatedBy($this)
					->find($con);
				if (null !== $criteria) {
					return $collGeneralInfosRelatedByUpdatedBy;
				}
				$this->collGeneralInfosRelatedByUpdatedBy = $collGeneralInfosRelatedByUpdatedBy;
			}
		}
		return $this->collGeneralInfosRelatedByUpdatedBy;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countGeneralInfosRelatedByUpdatedBy(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collGeneralInfosRelatedByUpdatedBy || null !== $criteria) {
			if ($this->isNew() && null === $this->collGeneralInfosRelatedByUpdatedBy) {
				return 0;
			...
			return count($this->collGeneralInfosRelatedByUpdatedBy);
		}
	}
	 ...
	 * @throws     PropelException
	 */
	public function addGeneralInfoRelatedByUpdatedBy(GeneralInfo $l)
	{
		if ($this->collGeneralInfosRelatedByUpdatedBy === null) {
			$this->initGeneralInfosRelatedByUpdatedBy();
		}
		if (!$this->collGeneralInfosRelatedByUpdatedBy->contains($l)) { // only add it if the **same** object is not already associated
			$this->collGeneralInfosRelatedByUpdatedBy[]= $l;
	 ...
	 * Otherwise if this sfGuardUser is new, it will return
	 * an empty collection; or if this sfGuardUser has previously
	 * been saved, it will retrieve related GeneralInfosRelatedByUpdatedBy from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in sfGuardUser.
	 ...
	 * @return     PropelCollection|array GeneralInfo[] List of GeneralInfo objects
	 */
	public function getGeneralInfosRelatedByUpdatedByJoinVessel($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('Vessel', $join_behavior);

		return $this->getGeneralInfosRelatedByUpdatedBy($query, $con);
	}
	 ...
	 * @return     PropelCollection|array GeneralInfo[] List of GeneralInfo objects
	 */
	public function getGeneralInfosRelatedByUpdatedByJoinSkipper($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('Skipper', $join_behavior);
	 ...
	 * @return     PropelCollection|array GeneralInfo[] List of GeneralInfo objects
	 */
	public function getGeneralInfosRelatedByUpdatedByJoinGuide($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('Guide', $join_behavior);
	 ...
	 * @return     PropelCollection|array GeneralInfo[] List of GeneralInfo objects
	 */
	public function getGeneralInfosRelatedByUpdatedByJoinCompany($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('Company', $join_behavior);
	...
	/**
	 * Clears out the collWatchInfosRelatedByCreatedBy collection
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addWatchInfosRelatedByCreatedBy()
	 */
	public function clearWatchInfosRelatedByCreatedBy()
	{
		$this->collWatchInfosRelatedByCreatedBy = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collWatchInfosRelatedByCreatedBy collection.
	 *
	 * By default this just sets the collWatchInfosRelatedByCreatedBy collection to an empty array (like clearcollWatchInfosRelatedByCreatedBy());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initWatchInfosRelatedByCreatedBy()
	{
		$this->collWatchInfosRelatedByCreatedBy = new PropelObjectCollection();
		$this->collWatchInfosRelatedByCreatedBy->setModel('WatchInfo');
	}
	 ...
	 * @throws     PropelException
	 */
	public function getWatchInfosRelatedByCreatedBy($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collWatchInfosRelatedByCreatedBy || null !== $criteria) {
			if ($this->isNew() && null === $this->collWatchInfosRelatedByCreatedBy) {
				// return empty collection
				$this->initWatchInfosRelatedByCreatedBy();
			} else {
				$collWatchInfosRelatedByCreatedBy = WatchInfoQuery::create(null, $criteria)
					->filterBysfGuardUserRelatedByCreatedBy($this)
					->find($con);
				if (null !== $criteria) {
					return $collWatchInfosRelatedByCreatedBy;
				}
				$this->collWatchInfosRelatedByCreatedBy = $collWatchInfosRelatedByCreatedBy;
			}
		}
		return $this->collWatchInfosRelatedByCreatedBy;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countWatchInfosRelatedByCreatedBy(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collWatchInfosRelatedByCreatedBy || null !== $criteria) {
			if ($this->isNew() && null === $this->collWatchInfosRelatedByCreatedBy) {
				return 0;
			...
			return count($this->collWatchInfosRelatedByCreatedBy);
		}
	}
	 ...
	 * @throws     PropelException
	 */
	public function addWatchInfoRelatedByCreatedBy(WatchInfo $l)
	{
		if ($this->collWatchInfosRelatedByCreatedBy === null) {
			$this->initWatchInfosRelatedByCreatedBy();
		}
		if (!$this->collWatchInfosRelatedByCreatedBy->contains($l)) { // only add it if the **same** object is not already associated
			$this->collWatchInfosRelatedByCreatedBy[]= $l;
			$l->setsfGuardUserRelatedByCreatedBy($this);
		}
	}
	 ...
	 * Otherwise if this sfGuardUser is new, it will return
	 * an empty collection; or if this sfGuardUser has previously
	 * been saved, it will retrieve related WatchInfosRelatedByCreatedBy from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in sfGuardUser.
	 ...
	 * @return     PropelCollection|array WatchInfo[] List of WatchInfo objects
	 */
	public function getWatchInfosRelatedByCreatedByJoinWatchPost($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = WatchInfoQuery::create(null, $criteria);
		$query->joinWith('WatchPost', $join_behavior);

		return $this->getWatchInfosRelatedByCreatedBy($query, $con);
	}
	 ...
	 * @return     PropelCollection|array WatchInfo[] List of WatchInfo objects
	 */
	public function getWatchInfosRelatedByCreatedByJoinWatchman($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = WatchInfoQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array WatchInfo[] List of WatchInfo objects
	 */
	public function getWatchInfosRelatedByCreatedByJoinCompany($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = WatchInfoQuery::create(null, $criteria);
		$query->joinWith('Company', $join_behavior);
	...
	/**
	 * Clears out the collWatchInfosRelatedByUpdatedBy collection
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addWatchInfosRelatedByUpdatedBy()
	 */
	public function clearWatchInfosRelatedByUpdatedBy()
	{
		$this->collWatchInfosRelatedByUpdatedBy = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collWatchInfosRelatedByUpdatedBy collection.
	 *
	 * By default this just sets the collWatchInfosRelatedByUpdatedBy collection to an empty array (like clearcollWatchInfosRelatedByUpdatedBy());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initWatchInfosRelatedByUpdatedBy()
	{
		$this->collWatchInfosRelatedByUpdatedBy = new PropelObjectCollection();
		$this->collWatchInfosRelatedByUpdatedBy->setModel('WatchInfo');
	}
	 ...
	 * @throws     PropelException
	 */
	public function getWatchInfosRelatedByUpdatedBy($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collWatchInfosRelatedByUpdatedBy || null !== $criteria) {
			if ($this->isNew() && null === $this->collWatchInfosRelatedByUpdatedBy) {
				// return empty collection
				$this->initWatchInfosRelatedByUpdatedBy();
			} else {
				$collWatchInfosRelatedByUpdatedBy = WatchInfoQuery::create(null, $criteria)
					->filterBysfGuardUserRelatedByUpdatedBy($this)
					->find($con);
				if (null !== $criteria) {
					return $collWatchInfosRelatedByUpdatedBy;
				}
				$this->collWatchInfosRelatedByUpdatedBy = $collWatchInfosRelatedByUpdatedBy;
			}
		}
		return $this->collWatchInfosRelatedByUpdatedBy;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countWatchInfosRelatedByUpdatedBy(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collWatchInfosRelatedByUpdatedBy || null !== $criteria) {
			if ($this->isNew() && null === $this->collWatchInfosRelatedByUpdatedBy) {
				return 0;
			...
			return count($this->collWatchInfosRelatedByUpdatedBy);
		}
	}
	 ...
	 * @throws     PropelException
	 */
	public function addWatchInfoRelatedByUpdatedBy(WatchInfo $l)
	{
		if ($this->collWatchInfosRelatedByUpdatedBy === null) {
			$this->initWatchInfosRelatedByUpdatedBy();
		}
		if (!$this->collWatchInfosRelatedByUpdatedBy->contains($l)) { // only add it if the **same** object is not already associated
			$this->collWatchInfosRelatedByUpdatedBy[]= $l;
			$l->setsfGuardUserRelatedByUpdatedBy($this);
		}
	}
	 ...
	 * Otherwise if this sfGuardUser is new, it will return
	 * an empty collection; or if this sfGuardUser has previously
	 * been saved, it will retrieve related WatchInfosRelatedByUpdatedBy from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in sfGuardUser.
	 ...
	 * @return     PropelCollection|array WatchInfo[] List of WatchInfo objects
	 */
	public function getWatchInfosRelatedByUpdatedByJoinWatchPost($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = WatchInfoQuery::create(null, $criteria);
		$query->joinWith('WatchPost', $join_behavior);

		return $this->getWatchInfosRelatedByUpdatedBy($query, $con);
	}
	 ...
	 * @return     PropelCollection|array WatchInfo[] List of WatchInfo objects
	 */
	public function getWatchInfosRelatedByUpdatedByJoinWatchman($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = WatchInfoQuery::create(null, $criteria);
		$query->joinWith('Watchman', $join_behavior);
	 ...
	 * @return     PropelCollection|array WatchInfo[] List of WatchInfo objects
	 */
	public function getWatchInfosRelatedByUpdatedByJoinCompany($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = WatchInfoQuery::create(null, $criteria);
		$query->joinWith('Company', $join_behavior);
	...
	/**
	 * Clears out the collprUsers collection
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	...
	/**
	 * Initializes the collprUsers collection.
	 *
	 * By default this just sets the collprUsers collection to an empty array (like clearcollprUsers());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	...
	/**
	 * Gets an array of prUser objects which contain a foreign key that references this object.
	 *
	 * If the $criteria is not null, it is used to always fetch the results from the database.
	 * Otherwise the results are fetched from the database the first time, then cached.
	 * Next time the same method is called without $criteria, the cached collection is returned.
	 ...
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array prUser[] List of prUser objects
	 * @throws     PropelException
	 */
	public function getprUsers($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collprUsers || null !== $criteria) {
			if ($this->isNew() && null === $this->collprUsers) {
				// return empty collection
				$this->initprUsers();
			} else {
				$collprUsers = prUserQuery::create(null, $criteria)
					->filterBysfGuardUser($this)
					->find($con);
				if (null !== $criteria) {
					return $collprUsers;
				}
				$this->collprUsers = $collprUsers;
			}
		}
		return $this->collprUsers;
	}

	/**
	 * Returns the number of related prUser objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related prUser objects.
	 * @throws     PropelException
	 */
	public function countprUsers(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collprUsers || null !== $criteria) {
			if ($this->isNew() && null === $this->collprUsers) {
				return 0;
			} else {
				$query = prUserQuery::create(null, $criteria);
				if($distinct) {
					$query->distinct();
				}
				return $query
			...
			return count($this->collprUsers);
		}
	}

	/**
	 * Method called to associate a prUser object to this object
	 * through the prUser foreign key attribute.
	 *
	 * @param      prUser $l prUser
	 * @return     void
	 * @throws     PropelException
	 */
	public function addprUser(prUser $l)
	{
		if ($this->collprUsers === null) {
			$this->initprUsers();
		}
		if (!$this->collprUsers->contains($l)) { // only add it if the **same** object is not already associated
			$this->collprUsers[]= $l;
			$l->setsfGuardUser($this);
		}
	}
	...
	/**
	 * Clears out the collObservationPhotosRelatedByLastEditedBy collection
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addObservationPhotosRelatedByLastEditedBy()
	 */
	public function clearObservationPhotosRelatedByLastEditedBy()
	{
		$this->collObservationPhotosRelatedByLastEditedBy = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collObservationPhotosRelatedByLastEditedBy collection.
	 *
	 * By default this just sets the collObservationPhotosRelatedByLastEditedBy collection to an empty array (like clearcollObservationPhotosRelatedByLastEditedBy());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initObservationPhotosRelatedByLastEditedBy()
	{
		$this->collObservationPhotosRelatedByLastEditedBy = new PropelObjectCollection();
		$this->collObservationPhotosRelatedByLastEditedBy->setModel('ObservationPhoto');
	}
	 ...
	 * @throws     PropelException
	 */
	public function getObservationPhotosRelatedByLastEditedBy($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collObservationPhotosRelatedByLastEditedBy || null !== $criteria) {
			if ($this->isNew() && null === $this->collObservationPhotosRelatedByLastEditedBy) {
				// return empty collection
				$this->initObservationPhotosRelatedByLastEditedBy();
			} else {
				$collObservationPhotosRelatedByLastEditedBy = ObservationPhotoQuery::create(null, $criteria)
					->filterBysfGuardUserRelatedByLastEditedBy($this)
					->find($con);
				if (null !== $criteria) {
					return $collObservationPhotosRelatedByLastEditedBy;
				}
				$this->collObservationPhotosRelatedByLastEditedBy = $collObservationPhotosRelatedByLastEditedBy;
			}
		}
		return $this->collObservationPhotosRelatedByLastEditedBy;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countObservationPhotosRelatedByLastEditedBy(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collObservationPhotosRelatedByLastEditedBy || null !== $criteria) {
			if ($this->isNew() && null === $this->collObservationPhotosRelatedByLastEditedBy) {
				return 0;
			...
			return count($this->collObservationPhotosRelatedByLastEditedBy);
		}
	}
	 ...
	 * @throws     PropelException
	 */
	public function addObservationPhotoRelatedByLastEditedBy(ObservationPhoto $l)
	{
		if ($this->collObservationPhotosRelatedByLastEditedBy === null) {
			$this->initObservationPhotosRelatedByLastEditedBy();
		}
		if (!$this->collObservationPhotosRelatedByLastEditedBy->contains($l)) { // only add it if the **same** object is not already associated
			$this->collObservationPhotosRelatedByLastEditedBy[]= $l;
			$l->setsfGuardUserRelatedByLastEditedBy($this);
		}
	}
	 ...
	 * Otherwise if this sfGuardUser is new, it will return
	 * an empty collection; or if this sfGuardUser has previously
	 * been saved, it will retrieve related ObservationPhotosRelatedByLastEditedBy from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in sfGuardUser.
	 ...
	 * @return     PropelCollection|array ObservationPhoto[] List of ObservationPhoto objects
	 */
	public function getObservationPhotosRelatedByLastEditedByJoinIndividual($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ObservationPhotoQuery::create(null, $criteria);
		$query->joinWith('Individual', $join_behavior);

		return $this->getObservationPhotosRelatedByLastEditedBy($query, $con);
	}
	 ...
	 * @return     PropelCollection|array ObservationPhoto[] List of ObservationPhoto objects
	 */
	public function getObservationPhotosRelatedByLastEditedByJoinSpecie($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ObservationPhotoQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array ObservationPhoto[] List of ObservationPhoto objects
	 */
	public function getObservationPhotosRelatedByLastEditedByJoinBodyPart($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ObservationPhotoQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array ObservationPhoto[] List of ObservationPhoto objects
	 */
	public function getObservationPhotosRelatedByLastEditedByJoinBehaviour($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ObservationPhotoQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array ObservationPhoto[] List of ObservationPhoto objects
	 */
	public function getObservationPhotosRelatedByLastEditedByJoinCompany($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ObservationPhotoQuery::create(null, $criteria);
		$query->joinWith('Company', $join_behavior);
	 ...
	 * @return     PropelCollection|array ObservationPhoto[] List of ObservationPhoto objects
	 */
	public function getObservationPhotosRelatedByLastEditedByJoinVessel($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ObservationPhotoQuery::create(null, $criteria);
		$query->joinWith('Vessel', $join_behavior);
	 ...
	 * @return     PropelCollection|array ObservationPhoto[] List of ObservationPhoto objects
	 */
	public function getObservationPhotosRelatedByLastEditedByJoinPhotographer($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ObservationPhotoQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array ObservationPhoto[] List of ObservationPhoto objects
	 */
	public function getObservationPhotosRelatedByLastEditedByJoinSighting($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ObservationPhotoQuery::create(null, $criteria);
	...
	/**
	 * Clears out the collObservationPhotosRelatedByValidatedBy collection
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addObservationPhotosRelatedByValidatedBy()
	 */
	public function clearObservationPhotosRelatedByValidatedBy()
	{
		$this->collObservationPhotosRelatedByValidatedBy = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collObservationPhotosRelatedByValidatedBy collection.
	 *
	 * By default this just sets the collObservationPhotosRelatedByValidatedBy collection to an empty array (like clearcollObservationPhotosRelatedByValidatedBy());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initObservationPhotosRelatedByValidatedBy()
	{
		$this->collObservationPhotosRelatedByValidatedBy = new PropelObjectCollection();
		$this->collObservationPhotosRelatedByValidatedBy->setModel('ObservationPhoto');
	}
	 ...
	 * @throws     PropelException
	 */
	public function getObservationPhotosRelatedByValidatedBy($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collObservationPhotosRelatedByValidatedBy || null !== $criteria) {
			if ($this->isNew() && null === $this->collObservationPhotosRelatedByValidatedBy) {
				// return empty collection
				$this->initObservationPhotosRelatedByValidatedBy();
			} else {
				$collObservationPhotosRelatedByValidatedBy = ObservationPhotoQuery::create(null, $criteria)
					->filterBysfGuardUserRelatedByValidatedBy($this)
					->find($con);
				if (null !== $criteria) {
					return $collObservationPhotosRelatedByValidatedBy;
				}
				$this->collObservationPhotosRelatedByValidatedBy = $collObservationPhotosRelatedByValidatedBy;
			}
		}
		return $this->collObservationPhotosRelatedByValidatedBy;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countObservationPhotosRelatedByValidatedBy(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collObservationPhotosRelatedByValidatedBy || null !== $criteria) {
			if ($this->isNew() && null === $this->collObservationPhotosRelatedByValidatedBy) {
				return 0;
			...
			return count($this->collObservationPhotosRelatedByValidatedBy);
		}
	}
	 ...
	 * @throws     PropelException
	 */
	public function addObservationPhotoRelatedByValidatedBy(ObservationPhoto $l)
	{
		if ($this->collObservationPhotosRelatedByValidatedBy === null) {
			$this->initObservationPhotosRelatedByValidatedBy();
		}
		if (!$this->collObservationPhotosRelatedByValidatedBy->contains($l)) { // only add it if the **same** object is not already associated
			$this->collObservationPhotosRelatedByValidatedBy[]= $l;
			$l->setsfGuardUserRelatedByValidatedBy($this);
		}
	}
	 ...
	 * Otherwise if this sfGuardUser is new, it will return
	 * an empty collection; or if this sfGuardUser has previously
	 * been saved, it will retrieve related ObservationPhotosRelatedByValidatedBy from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in sfGuardUser.
	 ...
	 * @return     PropelCollection|array ObservationPhoto[] List of ObservationPhoto objects
	 */
	public function getObservationPhotosRelatedByValidatedByJoinIndividual($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ObservationPhotoQuery::create(null, $criteria);
		$query->joinWith('Individual', $join_behavior);

		return $this->getObservationPhotosRelatedByValidatedBy($query, $con);
	}
	 ...
	 * @return     PropelCollection|array ObservationPhoto[] List of ObservationPhoto objects
	 */
	public function getObservationPhotosRelatedByValidatedByJoinSpecie($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ObservationPhotoQuery::create(null, $criteria);
		$query->joinWith('Specie', $join_behavior);
	 ...
	 * @return     PropelCollection|array ObservationPhoto[] List of ObservationPhoto objects
	 */
	public function getObservationPhotosRelatedByValidatedByJoinBodyPart($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ObservationPhotoQuery::create(null, $criteria);
		$query->joinWith('BodyPart', $join_behavior);
	 ...
	 * @return     PropelCollection|array ObservationPhoto[] List of ObservationPhoto objects
	 */
	public function getObservationPhotosRelatedByValidatedByJoinBehaviour($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ObservationPhotoQuery::create(null, $criteria);
		$query->joinWith('Behaviour', $join_behavior);
	 ...
	 * @return     PropelCollection|array ObservationPhoto[] List of ObservationPhoto objects
	 */
	public function getObservationPhotosRelatedByValidatedByJoinCompany($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ObservationPhotoQuery::create(null, $criteria);
		$query->joinWith('Company', $join_behavior);
	 ...
	 * @return     PropelCollection|array ObservationPhoto[] List of ObservationPhoto objects
	 */
	public function getObservationPhotosRelatedByValidatedByJoinVessel($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ObservationPhotoQuery::create(null, $criteria);
		$query->joinWith('Vessel', $join_behavior);
	 ...
	 * @return     PropelCollection|array ObservationPhoto[] List of ObservationPhoto objects
	 */
	public function getObservationPhotosRelatedByValidatedByJoinPhotographer($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ObservationPhotoQuery::create(null, $criteria);
		$query->joinWith('Photographer', $join_behavior);
	 ...
	 * @return     PropelCollection|array ObservationPhoto[] List of ObservationPhoto objects
	 */
	public function getObservationPhotosRelatedByValidatedByJoinSighting($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ObservationPhotoQuery::create(null, $criteria);
		$query->joinWith('Sighting', $join_behavior);
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			...
			if ($this->collGeneralInfosRelatedByCreatedBy) {
				foreach ((array) $this->collGeneralInfosRelatedByCreatedBy as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collGeneralInfosRelatedByUpdatedBy) {
				foreach ((array) $this->collGeneralInfosRelatedByUpdatedBy as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collUsers) {
			...
			if ($this->collWatchInfosRelatedByCreatedBy) {
				foreach ((array) $this->collWatchInfosRelatedByCreatedBy as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collWatchInfosRelatedByUpdatedBy) {
				foreach ((array) $this->collWatchInfosRelatedByUpdatedBy as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collprUsers) {
				foreach ((array) $this->collprUsers as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collObservationPhotosRelatedByLastEditedBy) {
				foreach ((array) $this->collObservationPhotosRelatedByLastEditedBy as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collObservationPhotosRelatedByValidatedBy) {
				foreach ((array) $this->collObservationPhotosRelatedByValidatedBy as $o) {
					$o->clearAllReferences($deep);
				}
			}
