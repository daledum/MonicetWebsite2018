...
abstract class BasesfGuardUser extends BaseObject  implements Persistent
{
  ...
  const PEER = 'sfGuardUserPeer';
	 ...
	 */
	protected $collGeneralInfosRelatedBySkipperId;

	/**
	 * @var        array GeneralInfo[] Collection to store aggregation of GeneralInfo objects.
	 */
	protected $collGeneralInfosRelatedByGuideId;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collGeneralInfosRelatedBySkipperId = null;

			$this->collGeneralInfosRelatedByGuideId = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collGeneralInfosRelatedBySkipperId !== null) {
				foreach ($this->collGeneralInfosRelatedBySkipperId as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collGeneralInfosRelatedByGuideId !== null) {
				foreach ($this->collGeneralInfosRelatedByGuideId as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getGeneralInfosRelatedBySkipperId() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addGeneralInfoRelatedBySkipperId($relObj->copy($deepCopy));
				}
			}

			foreach ($this->getGeneralInfosRelatedByGuideId() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addGeneralInfoRelatedByGuideId($relObj->copy($deepCopy));
				}
			}
	...
	/**
	 * Clears out the collGeneralInfosRelatedBySkipperId collection
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addGeneralInfosRelatedBySkipperId()
	 */
	public function clearGeneralInfosRelatedBySkipperId()
	{
		$this->collGeneralInfosRelatedBySkipperId = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collGeneralInfosRelatedBySkipperId collection.
	 *
	 * By default this just sets the collGeneralInfosRelatedBySkipperId collection to an empty array (like clearcollGeneralInfosRelatedBySkipperId());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initGeneralInfosRelatedBySkipperId()
	{
		$this->collGeneralInfosRelatedBySkipperId = new PropelObjectCollection();
		$this->collGeneralInfosRelatedBySkipperId->setModel('GeneralInfo');
	}
	 ...
	 * @throws     PropelException
	 */
	public function getGeneralInfosRelatedBySkipperId($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collGeneralInfosRelatedBySkipperId || null !== $criteria) {
			if ($this->isNew() && null === $this->collGeneralInfosRelatedBySkipperId) {
				// return empty collection
				$this->initGeneralInfosRelatedBySkipperId();
			} else {
				$collGeneralInfosRelatedBySkipperId = GeneralInfoQuery::create(null, $criteria)
					->filterBysfGuardUserRelatedBySkipperId($this)
					->find($con);
				if (null !== $criteria) {
					return $collGeneralInfosRelatedBySkipperId;
				}
				$this->collGeneralInfosRelatedBySkipperId = $collGeneralInfosRelatedBySkipperId;
			}
		}
		return $this->collGeneralInfosRelatedBySkipperId;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countGeneralInfosRelatedBySkipperId(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collGeneralInfosRelatedBySkipperId || null !== $criteria) {
			if ($this->isNew() && null === $this->collGeneralInfosRelatedBySkipperId) {
				return 0;
			...
			return count($this->collGeneralInfosRelatedBySkipperId);
		}
	}
	 ...
	 * @throws     PropelException
	 */
	public function addGeneralInfoRelatedBySkipperId(GeneralInfo $l)
	{
		if ($this->collGeneralInfosRelatedBySkipperId === null) {
			$this->initGeneralInfosRelatedBySkipperId();
		}
		if (!$this->collGeneralInfosRelatedBySkipperId->contains($l)) { // only add it if the **same** object is not already associated
			$this->collGeneralInfosRelatedBySkipperId[]= $l;
			$l->setsfGuardUserRelatedBySkipperId($this);
		}
	}
	 ...
	 * Otherwise if this sfGuardUser is new, it will return
	 * an empty collection; or if this sfGuardUser has previously
	 * been saved, it will retrieve related GeneralInfosRelatedBySkipperId from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in sfGuardUser.
	 */
	public function getGeneralInfosRelatedBySkipperIdJoinVessel($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('GeneralInfoRelatedBySkipperId.Vessel', $join_behavior);

		return $this->getGeneralInfosRelatedBySkipperId($query, $con);
	}
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getGeneralInfosRelatedBySkipperIdJoinCompany($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('GeneralInfoRelatedBySkipperId.Company', $join_behavior);

		return $this->getGeneralInfosRelatedBySkipperId($query, $con);
	}

	/**
	 * Clears out the collGeneralInfosRelatedByGuideId collection
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addGeneralInfosRelatedByGuideId()
	 */
	public function clearGeneralInfosRelatedByGuideId()
	{
		$this->collGeneralInfosRelatedByGuideId = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collGeneralInfosRelatedByGuideId collection.
	 *
	 * By default this just sets the collGeneralInfosRelatedByGuideId collection to an empty array (like clearcollGeneralInfosRelatedByGuideId());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initGeneralInfosRelatedByGuideId()
	{
		$this->collGeneralInfosRelatedByGuideId = new PropelObjectCollection();
		$this->collGeneralInfosRelatedByGuideId->setModel('GeneralInfo');
	}
	 ...
	 * @throws     PropelException
	 */
	public function getGeneralInfosRelatedByGuideId($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collGeneralInfosRelatedByGuideId || null !== $criteria) {
			if ($this->isNew() && null === $this->collGeneralInfosRelatedByGuideId) {
				// return empty collection
				$this->initGeneralInfosRelatedByGuideId();
			} else {
				$collGeneralInfosRelatedByGuideId = GeneralInfoQuery::create(null, $criteria)
					->filterBysfGuardUserRelatedByGuideId($this)
					->find($con);
				if (null !== $criteria) {
					return $collGeneralInfosRelatedByGuideId;
				}
				$this->collGeneralInfosRelatedByGuideId = $collGeneralInfosRelatedByGuideId;
			}
		}
		return $this->collGeneralInfosRelatedByGuideId;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countGeneralInfosRelatedByGuideId(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collGeneralInfosRelatedByGuideId || null !== $criteria) {
			if ($this->isNew() && null === $this->collGeneralInfosRelatedByGuideId) {
				return 0;
			...
			return count($this->collGeneralInfosRelatedByGuideId);
		}
	}
	 ...
	 * @throws     PropelException
	 */
	public function addGeneralInfoRelatedByGuideId(GeneralInfo $l)
	{
		if ($this->collGeneralInfosRelatedByGuideId === null) {
			$this->initGeneralInfosRelatedByGuideId();
		}
		if (!$this->collGeneralInfosRelatedByGuideId->contains($l)) { // only add it if the **same** object is not already associated
			$this->collGeneralInfosRelatedByGuideId[]= $l;
			$l->setsfGuardUserRelatedByGuideId($this);
		}
	}
	 ...
	 * Otherwise if this sfGuardUser is new, it will return
	 * an empty collection; or if this sfGuardUser has previously
	 * been saved, it will retrieve related GeneralInfosRelatedByGuideId from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in sfGuardUser.
	 */
	public function getGeneralInfosRelatedByGuideIdJoinVessel($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('GeneralInfoRelatedByGuideId.Vessel', $join_behavior);

		return $this->getGeneralInfosRelatedByGuideId($query, $con);
	}
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getGeneralInfosRelatedByGuideIdJoinCompany($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('GeneralInfoRelatedByGuideId.Company', $join_behavior);
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			...
			if ($this->collGeneralInfosRelatedBySkipperId) {
				foreach ((array) $this->collGeneralInfosRelatedBySkipperId as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collGeneralInfosRelatedByGuideId) {
				foreach ((array) $this->collGeneralInfosRelatedByGuideId as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collUsers) {
