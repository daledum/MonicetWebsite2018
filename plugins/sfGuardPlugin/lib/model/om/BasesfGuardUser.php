...
abstract class BasesfGuardUser extends BaseObject  implements Persistent
{
  ...
  const PEER = 'sfGuardUserPeer';
	...
	{
		$query = sfGuardUserPermissionQuery::create(null, $criteria);
		$query->joinWith('sfGuardUserPermission.sfGuardPermission', $join_behavior);
	...
	{
		$query = sfGuardUserGroupQuery::create(null, $criteria);
		$query->joinWith('sfGuardUserGroup.sfGuardGroup', $join_behavior);
	...
	{
		$query = CompanyUserQuery::create(null, $criteria);
		$query->joinWith('CompanyUser.Company', $join_behavior);
	...
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('GeneralInfoRelatedByCreatedBy.Vessel', $join_behavior);
	...
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('GeneralInfoRelatedByCreatedBy.Skipper', $join_behavior);
	...
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('GeneralInfoRelatedByCreatedBy.Guide', $join_behavior);
	...
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('GeneralInfoRelatedByCreatedBy.Company', $join_behavior);
	...
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('GeneralInfoRelatedByUpdatedBy.Vessel', $join_behavior);
	...
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('GeneralInfoRelatedByUpdatedBy.Skipper', $join_behavior);
	...
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('GeneralInfoRelatedByUpdatedBy.Guide', $join_behavior);
	...
	{
		$query = GeneralInfoQuery::create(null, $criteria);
		$query->joinWith('GeneralInfoRelatedByUpdatedBy.Company', $join_behavior);
	...
	{
		$query = WatchInfoQuery::create(null, $criteria);
		$query->joinWith('WatchInfoRelatedByCreatedBy.WatchPost', $join_behavior);
	...
	{
		$query = WatchInfoQuery::create(null, $criteria);
		$query->joinWith('WatchInfoRelatedByCreatedBy.Watchman', $join_behavior);
	...
	{
		$query = WatchInfoQuery::create(null, $criteria);
		$query->joinWith('WatchInfoRelatedByCreatedBy.Company', $join_behavior);
	...
	{
		$query = WatchInfoQuery::create(null, $criteria);
		$query->joinWith('WatchInfoRelatedByUpdatedBy.WatchPost', $join_behavior);
	...
	{
		$query = WatchInfoQuery::create(null, $criteria);
		$query->joinWith('WatchInfoRelatedByUpdatedBy.Watchman', $join_behavior);
	...
	{
		$query = WatchInfoQuery::create(null, $criteria);
		$query->joinWith('WatchInfoRelatedByUpdatedBy.Company', $join_behavior);
	...
	{
		$query = mfFormularioUtilizadorQuery::create(null, $criteria);
		$query->joinWith('mfFormularioUtilizador.mfFormulario', $join_behavior);
