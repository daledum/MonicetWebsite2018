 ...
 *
 * @method     sfGuardPermissionQuery leftJoinmfMenu($relationAlias = null) Adds a LEFT JOIN clause to the query using the mfMenu relation
 * @method     sfGuardPermissionQuery rightJoinmfMenu($relationAlias = null) Adds a RIGHT JOIN clause to the query using the mfMenu relation
 * @method     sfGuardPermissionQuery innerJoinmfMenu($relationAlias = null) Adds a INNER JOIN clause to the query using the mfMenu relation
 *
...
abstract class BasesfGuardPermissionQuery extends ModelCriteria
{
	 ...
	 * @return    sfGuardPermissionQuery The current query, for fluid interface
	 */
	public function filterBymfMenu($mfMenu, $comparison = null)
	{
		return $this
			->addUsingAlias(sfGuardPermissionPeer::ID, $mfMenu->getPermissaoId(), $comparison);
	}

	/**
	 * Adds a JOIN clause to the query using the mfMenu relation
	 * 
	 ...
	 * @return    sfGuardPermissionQuery The current query, for fluid interface
	 */
	public function joinmfMenu($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
	{
		$tableMap = $this->getTableMap();
		$relationMap = $tableMap->getRelation('mfMenu');
		...
		if($relationAlias) {
			...
			$this->addJoinObject($join, 'mfMenu');
		}
	 ...
	 */
	public function usemfMenuQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
	{
		return $this
			->joinmfMenu($relationAlias, $joinType)
